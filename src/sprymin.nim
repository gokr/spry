...
# sprymin: ELF 64-bit LSB  executable, x86-64, version 1 (SYSV), dynamically linked (uses shared libs), for GNU/Linux 2.6.24, BuildID
...
# sprymin: ELF 64-bit LSB  executable, x86-64, version 1 (SYSV), statically linked, for GNU/Linux 2.6.24, BuildID
...
# sprymin: ELF 64-bit LSB  executable, x86-64, version 1 (SYSV), statically linked, stripped
# Size: 128648 bytes
#
# Statically compiled optimized for size using diet-libc (had to create /usr/bin/dietgcc containing "diet gcc $@"):
# nim -d:release --opt:size --passL:-static --gcc.exe="dietgcc" --gcc.linkerexe="dietgcc" c sprymin && strip -s sprymin
# sprymin: ELF 64-bit LSB  executable, x86-64, version 1 (SYSV), statically linked, BuildID[sha1]=727e7658285c51ca27485b22af78b14d6d844e5b, stripped
# Size: 107920 bytes
#
