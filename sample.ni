...
# This is a word followed by a value.
echo "Hello"
...
# The "do" word will resolve and then run the code that the block
# contains. So this should echo "7". Its at this point that "+"
