...
var NTI198086 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NTI219017 = {size: 0, kind: 17, base: null, node: null, finalizer: null};
...
var NTI198017 = {size: 0, kind: 17, base: null, node: null, finalizer: null};
var NNI198017 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI198017.node = NNI198017;
...
var NNI219017 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI219017.node = NNI219017;
NTI219017.base = NTI190474;
...
var NNI198086 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "a", len: 0, typ: NTI104, name: "a", sons: null}, 
{kind: 1, offset: "b", len: 0, typ: NTI104, name: "b", sons: null}]};
NTI198086.node = NNI198086;
...
function negInt(a_23783) {
	var result_23784 = 0;

		result_23784 = (a_23783 * -1);

	return result_23784;

}
		var fact_table_58450 = [1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600];
...
function add_parser_extension_170535(ext_170537) {
		if (parser_exts_170506[0] != null) { parser_exts_170506[0].push(ext_170537); } else { parser_exts_170506[0] = [ext_170537]; };

	
}

function extend_parser_198571(p_198573) {
		if (p_198573.valueParsers != null) { p_198573.valueParsers.push({m_type: NTI198017, token: null}); } else { p_198573.valueParsers = [{m_type: NTI198017, token: null}]; };

	
}
add_parser_extension_170535(extend_parser_198571);
var state_200405 = [{a0: 1773455756, a1: 4275166512}];
var utc_instance_209631 = [null];
var local_instance_209632 = [null];
...
function new_parser_188358() {
	var result_188360 = null;
		...
		L1: do {
			var ex_189014 = null;
			var i_226038 = 0;
			var l_226039 = (parser_exts_170506[0] != null ? parser_exts_170506[0].length : 0);
			L2: do {
					L3: while (true) {
					if (!(i_226038 < l_226039)) break L3;
						ex_189014 = parser_exts_170506[0][chckIndx(i_226038, 0, parser_exts_170506[0].length+0-1)-0];
						ex_189014(result_188360);
						i_226038 = addInt(i_226038, 1);
						if (!(((parser_exts_170506[0] != null ? parser_exts_170506[0].length : 0) == l_226039))) {
...
function hash_162980(x_162982) {
	var result_162983 = 0;
		...
		L3: do {
			var i_163207 = 0;
			var colontmp__226070 = 0;
			colontmp__226070 = (x_162982 != null ? (x_162982.length-1) : -1);
			var res_226071 = i_162987;
			L4: do {
					L5: while (true) {
					if (!(res_226071 <= colontmp__226070)) break L5;
						i_163207 = res_226071;
						result_162983 = HEX21HEX26_162059(result_162983, hash_162869(x_162982[chckIndx(i_163207, 0, x_162982.length+0-1)-0]));
						res_226071 = addInt(res_226071, 1);
					}
			} while(false);
		} while(false);
...
function enlarge_184148(t_184154) {
		...
		n_184162 = new Array(chckRange(mulInt((t_184154.data != null ? t_184154.data.length : 0), 2), 0, 2147483647)); for (var i=0;i<chckRange(mulInt((t_184154.data != null ? t_184154.data.length : 0), 2), 0, 2147483647);++i) {n_184162[i]={Field0: 0, Field1: null, Field2: null};}		var Tmp1 = t_184154.data; t_184154.data = n_184162; n_184162 = Tmp1;		L2: do {
			var i_184321 = 0;
			var colontmp__226083 = 0;
			colontmp__226083 = (n_184162 != null ? (n_184162.length-1) : -1);
			var res_226088 = 0;
			L3: do {
					L4: while (true) {
					if (!(res_226088 <= colontmp__226083)) break L4;
						i_184321 = res_226088;
						...
						res_226088 = addInt(res_226088, 1);
					}
			} while(false);
		} while(false);
...
function enlarge_179348(t_179354) {
		...
		n_179362 = new Array(chckRange(mulInt((t_179354.data != null ? t_179354.data.length : 0), 2), 0, 2147483647)); for (var i=0;i<chckRange(mulInt((t_179354.data != null ? t_179354.data.length : 0), 2), 0, 2147483647);++i) {n_179362[i]={Field0: 0, Field1: null, Field2: null};}		var Tmp1 = t_179354.data; t_179354.data = n_179362; n_179362 = Tmp1;		L2: do {
			var i_179521 = 0;
			var colontmp__226102 = 0;
			colontmp__226102 = (n_179362 != null ? (n_179362.length-1) : -1);
			var res_226103 = 0;
			L3: do {
					L4: while (true) {
					if (!(res_226103 <= colontmp__226102)) break L4;
						i_179521 = res_226103;
						...
						res_226103 = addInt(res_226103, 1);
					}
			} while(false);
		} while(false);
...
function arg_parent_192604(spry_192606) {
	...
	BeforeRet: do {
		L1: do {
			...
			var colontmp__226126 = null;
			colontmp__226126 = spry_192606.currentActivation;
			var activation_226132 = colontmp__226126;
			L2: do {
					L3: while (true) {
					if (!!(!(isObj(activation_226132.m_type, NTI190489)))) break L3;
						activation_226132 = activation_226132.parent;
					}
			} while(false);
			activation_226132 = activation_226132.parent;
			L4: do {
					L5: while (true) {
					if (!!((activation_226132 == null))) break L5;
						activation_192608 = activation_226132;
						result_192607 = activation_192608;
						break BeforeRet;
						activation_226132 = activation_226132.parent;
						L6: do {
								L7: while (true) {
								if (!!(!(isObj(activation_226132.m_type, NTI190489)))) break L7;
									activation_226132 = activation_226132.parent;
								}
						} while(false);
					}
...
function find_186819(a_186823, item_186824) {
	...
	BeforeRet: do {
		L1: do {
			...
			L2: do {
					L3: while (true) {
					if (!(i_226143 < (a_186823 != null ? a_186823.length : 0))) break L3;
						i_186856 = a_186823[chckIndx(i_226143, 0, a_186823.length+0-1)-0];
						if (HEX3DHEX3D_172333(i_186856, item_186824)) {
						break BeforeRet;
						}
						
						result_186825 = addInt(result_186825, 1);
						i_226143 = addInt(i_226143, 1);
					}
			} while(false);
		} while(false);
		result_186825 = -1;
	...
	BeforeRet: do {
		...
		result_192524 = lookup_174154(module_192562, key_192523);
			...
			L1: do {
				...
				var colontmp__226148 = null;
				colontmp__226148 = spry_192522.currentActivation;
				var activation_226149 = colontmp__226148;
				L2: do {
						L3: while (true) {
						if (!!((activation_226149 == null))) break L3;
							L4: do {
									L5: while (true) {
									if (!!(!(isObj(activation_226149.m_type, NTI190489)))) break L5;
										if (isObj(activation_226149.m_type, NTI190487)) {
										Tmp6 = activation_226149.body.parent;
										}
										else {
										Tmp6 = activation_226149.parent;
										}
										
										activation_226149 = Tmp6;
									}
							} while(false);
							activation_192569 = activation_226149;
							...
							if (isObj(activation_226149.m_type, NTI190487)) {
							Tmp7 = activation_226149.body.parent;
							}
							else {
							Tmp7 = activation_226149.parent;
							}
							
							activation_226149 = Tmp7;
						}
				} while(false);
			} while(false);
			L8: do {
				var map_192583 = null;
				var colontmp__226156 = null;
				colontmp__226156 = spry_192522.modules.nodes;
				var i_226158 = 0;
				var l_226159 = (colontmp__226156 != null ? colontmp__226156.length : 0);
				L9: do {
						L10: while (true) {
						if (!(i_226158 < l_226159)) break L10;
							map_192583 = colontmp__226156[chckIndx(i_226158, 0, colontmp__226156.length+0-1)-0];
							...
							i_226158 = addInt(i_226158, 1);
							if (!(((colontmp__226156 != null ? colontmp__226156.length : 0) == l_226159))) {
							failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
							}
...
function nsuJoinSep(a_154059, sep_154060) {
	var result_154061 = null;
		...
		L1: do {
			var i_154086 = 0;
			var colontmp__226184 = 0;
			colontmp__226184 = (a_154059 != null ? (a_154059.length-1) : -1);
			var res_226185 = 0;
			L2: do {
					L3: while (true) {
					if (!(res_226185 <= colontmp__226184)) break L3;
						i_154086 = res_226185;
						...
						res_226185 = addInt(res_226185, 1);
					}
			} while(false);
		} while(false);
		...
		L4: do {
			var i_154106 = 0;
			var colontmp__226191 = 0;
			colontmp__226191 = (a_154059 != null ? (a_154059.length-1) : -1);
			var res_226192 = 1;
			L5: do {
					L6: while (true) {
					if (!(res_226192 <= colontmp__226191)) break L6;
						i_154106 = res_226192;
						...
						res_226192 = addInt(res_226192, 1);
					}
			} while(false);
		} while(false);
		}
...
function add_186740(x_186745, x_186745_Idx, y_186747) {
		...
		L2: do {
			var i_186778 = 0;
			var colontmp__226198 = 0;
			colontmp__226198 = (y_186747 != null ? (y_186747.length-1) : -1);
			var res_226199 = 0;
			L3: do {
					L4: while (true) {
					if (!(res_226199 <= colontmp__226198)) break L4;
						i_186778 = res_226199;
						...
						res_226199 = addInt(res_226199, 1);
					}
			} while(false);
		} while(false);
...
function nsuFindChar(s_154416, sub_154417, start_154418, last_154419) {
	...
	BeforeRet: do {
		...
		L2: do {
			var i_154806 = 0;
			var colontmp__226253 = 0;
			colontmp__226253 = start_154418;
			var res_226254 = colontmp__226253;
			L3: do {
					L4: while (true) {
					if (!(res_226254 <= last_154423)) break L4;
						i_154806 = res_226254;
						...
						res_226254 = addInt(res_226254, 1);
					}
			} while(false);
		} while(false);
		result_154421 = -1;
...
function nsuInitSkipTable(a_154144, sub_154145) {
		...
		L3: do {
			var i_154165 = 0;
			var colontmp__226261 = 0;
			colontmp__226261 = subInt(m_154146, 1);
			var i_226262 = 0;
			L4: do {
					L5: while (true) {
					if (!(i_226262 < colontmp__226261)) break L5;
						i_154165 = i_226262;
...
function substr_29622(s_29624, first_29625, last_29626) {
	var result_29627 = null;
		...
		L1: do {
			var i_29639 = 0;
			var colontmp__226278 = 0;
			colontmp__226278 = subInt(l_29630, 1);
			var res_226279 = 0;
			L2: do {
					L3: while (true) {
					if (!(res_226279 <= colontmp__226278)) break L3;
						i_29639 = res_226279;
						...
						res_226279 = addInt(res_226279, 1);
					}
			} while(false);
		} while(false);
...
function nsuSplitString(s_149739, sep_149740, maxsplit_149742) {
	var result_149744 = null;
		...
		L1: do {
			var x_149801 = null;
			var last_226271 = 0;
			var splits_226272 = maxsplit_149742;
			L2: do {
					L3: while (true) {
					if (!(last_226271 <= (s_149739 != null ? s_149739.length : 0))) break L3;
						var first_226274 = last_226271;
						L4: do {
								L5: while (true) {
								if (!((last_226271 < (s_149739 != null ? s_149739.length : 0)) && !(substr_eq_149102(s_149739, last_226271, sep_149740)))) break L5;
									last_226271 = addInt(last_226271, 1);
								}
						} while(false);
						if ((splits_226272 == 0)) {
						last_226271 = (s_149739 != null ? s_149739.length : 0);
						}
						
						x_149801 = substr_29622(s_149739, first_226274, subInt(last_226271, 1));
						...
						splits_226272 = subInt(splits_226272, 1);
						last_226271 = addInt(last_226271, (sep_149740 != null ? sep_149740.length : 0));
					}
			} while(false);
		} while(false);
...
function new_word_or_value_189984(self_189986) {
	...
	BeforeRet: do {
		...
		L1: do {
			var p_190214 = null;
			var colontmp__226214 = null;
			colontmp__226214 = self_189986.valueParsers;
			var i_226215 = 0;
			var l_226216 = (colontmp__226214 != null ? colontmp__226214.length : 0);
			L2: do {
					L3: while (true) {
					if (!(i_226215 < l_226216)) break L3;
						p_190214 = colontmp__226214[chckIndx(i_226215, 0, colontmp__226214.length+0-1)-0];
						...
						i_226215 = addInt(i_226215, 1);
						if (!(((colontmp__226214 != null ? colontmp__226214.length : 0) == l_226216))) {
						failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
						}
					...
					if (self_190277.token != null) { addChar(self_190277.token, ch_190280); } else { self_190277.token = [ch_190280]; };
						...
						if (self_190277.token != null) { addChar(self_190277.token, ch_190280); } else { self_190277.token = [ch_190280]; };
							...
							if (self_190277.ws != null) { addChar(self_190277.ws, ch_190280); } else { self_190277.ws = [ch_190280]; };
								...
								L4: do {
									var p_190341 = null;
									var colontmp__226175 = null;
									colontmp__226175 = self_190277.valueParsers;
									var i_226177 = 0;
									var l_226178 = (colontmp__226175 != null ? colontmp__226175.length : 0);
									L5: do {
											L6: while (true) {
											if (!(i_226177 < l_226178)) break L6;
												p_190341 = colontmp__226175[chckIndx(i_226177, 0, colontmp__226175.length+0-1)-0];
												...
												i_226177 = addInt(i_226177, 1);
												if (!(((colontmp__226175 != null ? colontmp__226175.length : 0) == l_226178))) {
												failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
												}
...
function HEX5BHEX5D_196278(s_196284, x_196286) {
	var result_196288 = null;

		var a_196401 = x_196286.a;
		var l_196601 = addInt(subInt(x_196286.b, a_196401), 1);
		result_196288 = new Array(chckRange(l_196601, 0, 2147483647)); for (var i=0;i<chckRange(l_196601, 0, 2147483647);++i) {result_196288[i]=null;}		L1: do {
			var i_196616 = 0;
			var i_226319 = 0;
			L2: do {
					L3: while (true) {
					if (!(i_226319 < l_196601)) break L3;
						i_196616 = i_226319;
						result_196288[chckIndx(i_196616, 0, result_196288.length+0-1)-0] = s_196284[chckIndx(addInt(i_196616, a_196401), 0, s_196284.length+0-1)-0];
						i_226319 = addInt(i_226319, 1);
					}
			} while(false);
		} while(false);

	return result_196288;
...
function add_core_195041(spry_195043) {

		function HEX3Aanonymous_195044(spry_195046) {
			var result_195047 = null;

				result_195047 = spry_195046.root;

			return result_195047;

		}

		function HEX3Aanonymous_195061(spry_195063) {
			var result_195064 = null;

				result_195064 = spry_195063.currentActivation;

			return result_195064;

		}

		function HEX3Aanonymous_195078(spry_195080) {
											var Tmp6;
								var Tmp7;
			...
			BeforeRet: do {
				L1: do {
					var activation_195082 = null;
					var colontmp__226113 = null;
					colontmp__226113 = spry_195080.currentActivation;
					var activation_226119 = colontmp__226113;
					L2: do {
							L3: while (true) {
							if (!!((activation_226119 == null))) break L3;
								L4: do {
										L5: while (true) {
										if (!!(!(isObj(activation_226119.m_type, NTI190489)))) break L5;
											if (isObj(activation_226119.m_type, NTI190487)) {
											Tmp6 = activation_226119.body.parent;
											}
											else {
											Tmp6 = activation_226119.parent;
											}
											
											activation_226119 = Tmp6;
										}
								} while(false);
								activation_195082 = activation_226119;
								if ((activation_195082.locals == null)) {
								activation_195082.locals = new_map_181637();
								}
								
								result_195081 = activation_195082.locals;
								break BeforeRet;
								if (isObj(activation_226119.m_type, NTI190487)) {
								Tmp7 = activation_226119.body.parent;
								}
								else {
								Tmp7 = activation_226119.parent;
								}
								
								activation_226119 = Tmp7;
							}
					} while(false);
				} while(false);
			} while (false);
		...
		function HEX3Aanonymous_195101(spry_195103) {
			var result_195104 = null;

				var act_195105 = arg_parent_192604(spry_195103);
				if (!((act_195105 == null))) {
				result_195104 = act_195105.last;
				if ((result_195104 == null)) {
				spry_195103.currentActivation.self = spry_195103.nilVal;
				result_195104 = spry_195103.nilVal;
				}
				
				}
				

			return result_195104;

		}

		function HEX3Aanonymous_195130(spry_195132) {
			var result_195133 = null;

				result_195133 = self_192930(spry_195132);

			return result_195133;

		}

		function HEX3Aanonymous_195147(spry_195149) {
			var result_195150 = null;

				result_195150 = spry_195149.lastSelf;
				if ((result_195150 == null)) {
				result_195150 = spry_195149.nilVal;
				}
				

			return result_195150;

		}

		function HEX3Aanonymous_195169(spry_195171) {
			var result_195172 = null;

				result_195172 = eval_arg_infix_192913(spry_195171);
				var tag_195173 = eval_arg_192974(spry_195171);
				if ((result_195172.tags == null)) {
				result_195172.tags = new_blok_186326();
				}
				
				if (isObj(tag_195173.m_type, NTI170152)) {
				add_186711(result_195172.tags, tag_195173);
				}
				else {
				add_186711(result_195172.tags, litify_193994(spry_195171, tag_195173));
				}
				

			return result_195172;

		}

		function HEX3Aanonymous_195215(spry_195217) {
			var result_195218 = null;

			BeforeRet: do {
				var node_195219 = eval_arg_infix_192913(spry_195217);
				var tag_195220 = eval_arg_192974(spry_195217);
				if ((node_195219.tags == null)) {
				result_195218 = spry_195217.falseVal;
				break BeforeRet;
				}
				
				if (isObj(tag_195220.m_type, NTI170152)) {
				result_195218 = bool_val_193009(contains_186806(node_195219.tags, tag_195220), spry_195217);
				break BeforeRet;
				}
				else {
					result_195218 = bool_val_193009(contains_186806(node_195219.tags, litify_193994(spry_195217, tag_195220)), spry_195217);
					break BeforeRet;
				}
				
			} while (false);

			return result_195218;

		}

		function HEX3Aanonymous_195247(spry_195249) {
			var result_195250 = null;

			BeforeRet: do {
				var node_195251 = eval_arg_infix_192913(spry_195249);
				if ((node_195251.tags == null)) {
				result_195250 = spry_195249.emptyBlok;
				break BeforeRet;
				}
				
				result_195250 = node_195251.tags;
				break BeforeRet;
			} while (false);

			return result_195250;

		}

		function HEX3Aanonymous_195270(spry_195272) {
			var result_195273 = null;

				result_195273 = eval_arg_infix_192913(spry_195272);
				result_195273.tags = eval_arg_192974(spry_195272);

			return result_195273;

		}

		function HEX3Aanonymous_195287(spry_195289) {
			var result_195290 = null;

				result_195290 = eval_arg_192974(spry_195289);
				assign_192861(spry_195289, arg_infix_192879(spry_195289), result_195290);

			return result_195290;

		}

		function HEX3Aanonymous_195304(spry_195306) {
			var result_195307 = null;

				result_195307 = eval_arg_192974(spry_195306);
				assign_192861(spry_195306, eval_arg_infix_192913(spry_195306), result_195307);

			return result_195307;

		}

		function HEX3Aanonymous_195321(spry_195323) {
			var result_195324 = null;

			BeforeRet: do {
				var binding_195325 = lookup_192520(spry_195323, arg_infix_192879(spry_195323));
				if ((binding_195325 == null)) {
				result_195324 = spry_195323.falseVal;
				break BeforeRet;
				}
				
				result_195324 = spry_195323.trueVal;
				break BeforeRet;
			} while (false);

			return result_195324;

		}

		function HEX3Aanonymous_195344(spry_195346) {
			var result_195347 = null;

			BeforeRet: do {
				var binding_195348 = lookup_192520(spry_195346, arg_infix_192879(spry_195346));
				if ((binding_195348 == null)) {
				result_195347 = spry_195346.falseVal;
				break BeforeRet;
				}
				
				if (HEX3DHEX3D_172333(binding_195348.val, spry_195346.nilVal)) {
				result_195347 = spry_195346.trueVal;
				break BeforeRet;
				}
			...
			return result_195347;

		}

		function HEX3Aanonymous_195367(spry_195369) {
			var result_195370 = null;

				result_195370 = new_value_186616(!(isObj(eval_arg_infix_192913(spry_195369).m_type, NTI170206)));

			return result_195370;

		}

		function HEX3Aanonymous_195392(spry_195394) {
			var result_195395 = null;

				result_195395 = HEX2B_191487(eval_arg_infix_192913(spry_195394), eval_arg_192974(spry_195394));

			return result_195395;

		}

		function HEX3Aanonymous_195409(spry_195411) {
			var result_195412 = null;

				result_195412 = HEX2D_191580(eval_arg_infix_192913(spry_195411), eval_arg_192974(spry_195411));

			return result_195412;

		}

		function HEX3Aanonymous_195426(spry_195428) {
			var result_195429 = null;

				result_195429 = HEX2A_191673(eval_arg_infix_192913(spry_195428), eval_arg_192974(spry_195428));

			return result_195429;

		}

		function HEX3Aanonymous_195443(spry_195445) {
			var result_195446 = null;

				result_195446 = HEX2F_191766(eval_arg_infix_192913(spry_195445), eval_arg_192974(spry_195445));

			return result_195446;

		}

		function HEX3Aanonymous_195460(spry_195462) {
			var result_195463 = null;

				result_195463 = HEX3C_191859(eval_arg_infix_192913(spry_195462), eval_arg_192974(spry_195462));

			return result_195463;

		}

		function HEX3Aanonymous_195477(spry_195479) {
			var result_195480 = null;

				result_195480 = HEX3C_191859(eval_arg_192974(spry_195479), eval_arg_infix_192913(spry_195479));

			return result_195480;

		}

		function HEX3Aanonymous_195494(spry_195496) {
			var result_195497 = null;

				result_195497 = HEX3CHEX3D_191970(eval_arg_infix_192913(spry_195496), eval_arg_192974(spry_195496));

			return result_195497;

		}

		function HEX3Aanonymous_195511(spry_195513) {
			var result_195514 = null;

				result_195514 = HEX3CHEX3D_191970(eval_arg_192974(spry_195513), eval_arg_infix_192913(spry_195513));

			return result_195514;

		}

		function HEX3Aanonymous_195528(spry_195530) {
			var result_195531 = null;

				result_195531 = eq_192081(eval_arg_infix_192913(spry_195530), eval_arg_192974(spry_195530));

			return result_195531;

		}

		function HEX3Aanonymous_195545(spry_195547) {
			var result_195548 = null;

				result_195548 = new_value_186616((eval_arg_infix_192913(spry_195547) == eval_arg_192974(spry_195547)));

			return result_195548;

		}

		function HEX3Aanonymous_195569(spry_195571) {
			var result_195572 = null;

				result_195572 = new_value_186616(!(value_172612(eq_192081(eval_arg_infix_192913(spry_195571), eval_arg_192974(spry_195571)))));

			return result_195572;

		}

		function HEX3Aanonymous_195586(spry_195588) {
			var result_195589 = null;

				result_195589 = new_value_186616(!((eval_arg_infix_192913(spry_195588) == eval_arg_192974(spry_195588))));

			return result_195589;

		}

		function HEX3Aanonymous_195610(spry_195612) {
			var result_195613 = null;

				result_195613 = new_value_186616(!(value_172612(eval_arg_infix_192913(spry_195612))));

			return result_195613;

		}

		function HEX3Aanonymous_195627(spry_195629) {
				var Tmp1;

			var result_195630 = null;

				var arg1_195631 = value_172612(eval_arg_infix_192913(spry_195629));
				var arg2_195632 = arg_192896(spry_195629);
				if (!arg1_195631) Tmp1 = false; else {					Tmp1 = value_172612(eval_190559(arg2_195632, spry_195629));				}				result_195630 = new_value_186616(Tmp1);

			return result_195630;

		}

		function HEX3Aanonymous_195646(spry_195648) {
				var Tmp1;

			var result_195649 = null;

				var arg1_195650 = value_172612(eval_arg_infix_192913(spry_195648));
				var arg2_195651 = arg_192896(spry_195648);
				if (arg1_195650) Tmp1 = true; else {					Tmp1 = value_172612(eval_190559(arg2_195651, spry_195648));				}				result_195649 = new_value_186616(Tmp1);

			return result_195649;

		}

		function HEX3Aanonymous_195665(spry_195667) {
			var result_195668 = null;

			BeforeRet: do {
				var val_195669 = eval_arg_infix_192913(spry_195667);
				if (isObj(val_195669.m_type, NTI170194)) {
				result_195668 = HEX26_192266(val_195669, eval_arg_192974(spry_195667));
				break BeforeRet;
				}
				else {
				if (isObj(val_195669.m_type, NTI170220)) {
				result_195668 = concat_187088(val_195669, eval_arg_192974(spry_195667).nodes);
				break BeforeRet;
				}
				else {
				if (isObj(val_195669.m_type, NTI170216)) {
				result_195668 = concat_187088(val_195669, eval_arg_192974(spry_195667).nodes);
				break BeforeRet;
				}
				else {
				if (isObj(val_195669.m_type, NTI170218)) {
				result_195668 = concat_187088(val_195669, eval_arg_192974(spry_195667).nodes);
				break BeforeRet;
				}
				}}}
			...
			return result_195668;

		}

		function HEX3Aanonymous_195715(spry_195717) {
			var result_195718 = null;

				result_195718 = new_value_186552(print_174068(eval_arg_infix_192913(spry_195717)));

			return result_195718;

		}

		function HEX3Aanonymous_195732(spry_195734) {
			var result_195735 = null;

			BeforeRet: do {
				var val_195736 = eval_arg_infix_192913(spry_195734);
				if (isObj(val_195736.m_type, NTI170191)) {
				result_195735 = val_195736;
				break BeforeRet;
				}
				else {
				if (isObj(val_195736.m_type, NTI170188)) {
				result_195735 = new_value_186520(val_195736.value);
				break BeforeRet;
				}
				else {
			...
			return result_195735;

		}

		function HEX3Aanonymous_195766(spry_195768) {
			var result_195769 = null;

			BeforeRet: do {
				var val_195770 = eval_arg_infix_192913(spry_195768);
				if (isObj(val_195770.m_type, NTI170188)) {
				result_195769 = val_195770;
				break BeforeRet;
				}
				else {
				if (isObj(val_195770.m_type, NTI170191)) {
				result_195769 = new_value_186488(Math.trunc(val_195770.value));
				break BeforeRet;
				}
				else {
			...
			return result_195769;

		}

		function HEX3Aanonymous_195800(spry_195802) {
			var result_195803 = null;

				result_195803 = new_value_186552(HEX24_170617(eval_arg_192974(spry_195802)));

			return result_195803;

		}

		function HEX3Aanonymous_195817(spry_195819) {
			var result_195820 = null;

				result_195820 = parse_190275(spry_195819.parser, eval_arg_192974(spry_195819).value);

			return result_195820;

		}

		function HEX3Aanonymous_195834(spry_195836) {
				var Tmp1;

			var result_195837 = null;

			BeforeRet: do {
				var comp_195838 = eval_arg_infix_192913(spry_195836);
				if (isObj(comp_195838.m_type, NTI170194)) {
				result_195837 = new_value_186488((comp_195838.value != null ? comp_195838.value.length : 0));
				}
				else {
				if (isObj(comp_195838.m_type, NTI170212)) {
				result_195837 = new_value_186488(((Tmp1 = eval_arg_infix_192913(spry_195836).nodes, Tmp1) != null ? Tmp1.length : 0));
				break BeforeRet;
				}
				else {
				if (isObj(comp_195838.m_type, NTI170223)) {
				result_195837 = new_value_186488(len_170785(eval_arg_infix_192913(spry_195836).bindings));
				break BeforeRet;
				}
				}}
			} while (false);

			return result_195837;

		}

		function HEX3Aanonymous_196013(spry_196015) {
			var result_196016 = null;

			BeforeRet: do {
				var comp_196017 = eval_arg_infix_192913(spry_196015);
				if (isObj(comp_196017.m_type, NTI170212)) {
				result_196016 = HEX5BHEX5D_190871(comp_196017, eval_arg_192974(spry_196015));
				break BeforeRet;
				}
				else {
				if (isObj(comp_196017.m_type, NTI170223)) {
				var hit_196034 = HEX5BHEX5D_190654(comp_196017, eval_arg_192974(spry_196015));
				if ((hit_196034 == null)) {
				result_196016 = spry_196015.undefVal;
				break BeforeRet;
				}
				else {
					result_196016 = hit_196034;
					break BeforeRet;
				}
		...
		function HEX3Aanonymous_196053(spry_196055) {
			var result_196056 = null;

			BeforeRet: do {
				var comp_196057 = eval_arg_infix_192913(spry_196055);
				var key_196058 = eval_arg_192974(spry_196055);
				var val_196059 = eval_arg_192974(spry_196055);
				if (isObj(comp_196057.m_type, NTI170212)) {
				HEX5BHEX5DHEX3D_190943(comp_196057, key_196058, val_196059);
				}
				else {
				if (isObj(comp_196057.m_type, NTI170223)) {
				HEX5BHEX5DHEX3D_190925(comp_196057, key_196058, val_196059);
				}
				}
				result_196056 = comp_196057;
				break BeforeRet;
			} while (false);

			return result_196056;

		}

		function HEX3Aanonymous_196089(spry_196091) {
				var Tmp1;

			var result_196092 = null;

				var comp_196093 = eval_arg_infix_192913(spry_196091);
				var word_196094 = arg_192896(spry_196091);
				var hit_196095 = HEX5BHEX5D_190654(comp_196093, word_196094);
				if ((hit_196095 == null)) {
				Tmp1 = spry_196091.undefVal;
				}
				else {
				Tmp1 = hit_196095;
				}
			...
			return result_196092;

		}

		function HEX3Aanonymous_196114(spry_196116) {
			var result_196117 = null;

			BeforeRet: do {
				var comp_196118 = eval_arg_infix_192913(spry_196116);
				var word_196119 = arg_192896(spry_196116);
				var val_196120 = eval_arg_192974(spry_196116);
				HEX5BHEX5DHEX3D_190925(comp_196118, word_196119, val_196120);
				result_196117 = comp_196118;
				break BeforeRet;
			} while (false);

			return result_196117;

		}

		function HEX3Aanonymous_196134(spry_196136) {
			var result_196137 = null;

			BeforeRet: do {
				var comp_196138 = eval_arg_infix_192913(spry_196136);
				var key_196139 = eval_arg_192974(spry_196136);
				if (isObj(comp_196138.m_type, NTI170212)) {
				result_196137 = new_value_186616(contains_186806(comp_196138, key_196139));
				break BeforeRet;
				}
				else {
				if (isObj(comp_196138.m_type, NTI170223)) {
				result_196137 = new_value_186616(contains_186904(comp_196138, key_196139));
				break BeforeRet;
				}
				}
				result_196137 = comp_196138;
				break BeforeRet;
			} while (false);

			return result_196137;

		}

		function HEX3Aanonymous_196169(spry_196171) {
			var result_196172 = null;

				result_196172 = eval_arg_infix_192913(spry_196171);
				var comp_196173 = result_196172;
				add_186711(comp_196173, eval_arg_192974(spry_196171));

			return result_196172;

		}

		function HEX3Aanonymous_196187(spry_196189) {
			var result_196190 = null;

				result_196190 = eval_arg_infix_192913(spry_196189);
				var comp_196191 = result_196190;
				remove_last_187532(comp_196191);

			return result_196190;

		}

		function HEX3Aanonymous_196205(spry_196207) {
			var result_196208 = null;

				var comp_196209 = eval_arg_infix_192913(spry_196207);
				var frm_196210 = eval_arg_192974(spry_196207).value;
				var to_196211 = eval_arg_192974(spry_196207).value;
				if (isObj(comp_196209.m_type, NTI170194)) {
				result_196208 = new_value_186552(HEX5BHEX5D_74681(comp_196209.value, HEX2EHEX2E_74620(frm_196210, to_196211)));
				}
				else {
				if (isObj(comp_196209.m_type, NTI170220)) {
				result_196208 = new_blok_186293(HEX5BHEX5D_196278(comp_196209.nodes, HEX2EHEX2E_74620(frm_196210, to_196211)));
				}
				else {
				if (isObj(comp_196209.m_type, NTI170216)) {
				result_196208 = new_paren_186358(HEX5BHEX5D_196278(comp_196209.nodes, HEX2EHEX2E_74620(frm_196210, to_196211)));
				}
				else {
				if (isObj(comp_196209.m_type, NTI170218)) {
				result_196208 = new_curly_186423(HEX5BHEX5D_196278(comp_196209.nodes, HEX2EHEX2E_74620(frm_196210, to_196211)));
				}
				}}}
				if (!((comp_196209.tags == null))) {
				result_196208.tags = comp_196209.tags;
				}
				

			return result_196208;
		...
		function HEX3Aanonymous_196723(spry_196725) {
			...
			BeforeRet: do {
				...
				L1: do {
					...
					var colontmp__226325 = null;
					colontmp__226325 = blk1_196727.nodes;
					var i_226326 = 0;
					var l_226327 = (colontmp__226325 != null ? colontmp__226325.length : 0);
					L2: do {
							L3: while (true) {
							if (!(i_226326 < l_226327)) break L3;
								each_196739 = colontmp__226325[chckIndx(i_226326, 0, colontmp__226325.length+0-1)-0];
								...
								current_196729.pos = 0;
								i_226326 = addInt(i_226326, 1);
								if (!(((colontmp__226325 != null ? colontmp__226325.length : 0) == l_226327))) {
								failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
								}
		...
		function HEX3Aanonymous_197061(spry_197063) {
			...
			BeforeRet: do {
				...
				L1: do {
					...
					L2: do {
							L3: while (true) {
							if (!(res_226335 <= times_197065)) break L3;
								i_197075 = res_226335;
								...
								res_226335 = addInt(res_226335, 1);
							}
					} while(false);
				} while(false);
			} while (false);
		...
		function HEX3Aanonymous_197089(spry_197091) {
			...
			BeforeRet: do {
				...
				L1: do {
					var i_197106 = 0;
					var res_226341 = frm_197094;
					L2: do {
							L3: while (true) {
							if (!(res_226341 <= to_197095)) break L3;
								i_197106 = res_226341;
								...
								res_226341 = addInt(res_226341, 1);
							}
					} while(false);
				} while(false);
				current_197097.body.nodes[chckIndx(0, 0, current_197097.body.nodes.length+0-1)-0] = orig_197098;
		...
		make_word_192991(spry_195043, makeNimstrLit("root"), new_prim_func_191037(HEX3Aanonymous_195044));
		make_word_192991(spry_195043, makeNimstrLit("activation"), new_prim_func_191037(HEX3Aanonymous_195061));
		make_word_192991(spry_195043, makeNimstrLit("locals"), new_prim_func_191037(HEX3Aanonymous_195078));
		make_word_192991(spry_195043, makeNimstrLit("node"), new_prim_func_191037(HEX3Aanonymous_195101));
		make_word_192991(spry_195043, makeNimstrLit("self"), new_prim_func_191037(HEX3Aanonymous_195130));
		make_word_192991(spry_195043, makeNimstrLit(";"), new_prim_func_191037(HEX3Aanonymous_195147));
		make_word_192991(spry_195043, makeNimstrLit("tag:"), new_prim_meth_191069(HEX3Aanonymous_195169));
		make_word_192991(spry_195043, makeNimstrLit("tag?"), new_prim_meth_191069(HEX3Aanonymous_195215));
		make_word_192991(spry_195043, makeNimstrLit("tags"), new_prim_meth_191069(HEX3Aanonymous_195247));
		make_word_192991(spry_195043, makeNimstrLit("tags:"), new_prim_meth_191069(HEX3Aanonymous_195270));
		make_word_192991(spry_195043, makeNimstrLit("="), new_prim_meth_191069(HEX3Aanonymous_195287));
		make_word_192991(spry_195043, makeNimstrLit("set:"), new_prim_meth_191069(HEX3Aanonymous_195304));
		make_word_192991(spry_195043, makeNimstrLit("?"), new_prim_meth_191069(HEX3Aanonymous_195321));
		make_word_192991(spry_195043, makeNimstrLit("nil?"), new_prim_meth_191069(HEX3Aanonymous_195344));
		make_word_192991(spry_195043, makeNimstrLit("set?"), new_prim_meth_191069(HEX3Aanonymous_195367));
		make_word_192991(spry_195043, makeNimstrLit("+"), new_prim_meth_191069(HEX3Aanonymous_195392));
		make_word_192991(spry_195043, makeNimstrLit("-"), new_prim_meth_191069(HEX3Aanonymous_195409));
		make_word_192991(spry_195043, makeNimstrLit("*"), new_prim_meth_191069(HEX3Aanonymous_195426));
		make_word_192991(spry_195043, makeNimstrLit("/"), new_prim_meth_191069(HEX3Aanonymous_195443));
		make_word_192991(spry_195043, makeNimstrLit("<"), new_prim_meth_191069(HEX3Aanonymous_195460));
		make_word_192991(spry_195043, makeNimstrLit(">"), new_prim_meth_191069(HEX3Aanonymous_195477));
		make_word_192991(spry_195043, makeNimstrLit("<="), new_prim_meth_191069(HEX3Aanonymous_195494));
		make_word_192991(spry_195043, makeNimstrLit(">="), new_prim_meth_191069(HEX3Aanonymous_195511));
		make_word_192991(spry_195043, makeNimstrLit("=="), new_prim_meth_191069(HEX3Aanonymous_195528));
		make_word_192991(spry_195043, makeNimstrLit("==="), new_prim_meth_191069(HEX3Aanonymous_195545));
		make_word_192991(spry_195043, makeNimstrLit("!="), new_prim_meth_191069(HEX3Aanonymous_195569));
		make_word_192991(spry_195043, makeNimstrLit("!=="), new_prim_meth_191069(HEX3Aanonymous_195586));
		make_word_192991(spry_195043, makeNimstrLit("not"), new_prim_meth_191069(HEX3Aanonymous_195610));
		make_word_192991(spry_195043, makeNimstrLit("and"), new_prim_meth_191069(HEX3Aanonymous_195627));
		make_word_192991(spry_195043, makeNimstrLit("or"), new_prim_meth_191069(HEX3Aanonymous_195646));
		make_word_192991(spry_195043, makeNimstrLit(","), new_prim_meth_191069(HEX3Aanonymous_195665));
		make_word_192991(spry_195043, makeNimstrLit("print"), new_prim_meth_191069(HEX3Aanonymous_195715));
		make_word_192991(spry_195043, makeNimstrLit("asFloat"), new_prim_meth_191069(HEX3Aanonymous_195732));
		make_word_192991(spry_195043, makeNimstrLit("asInt"), new_prim_meth_191069(HEX3Aanonymous_195766));
		make_word_192991(spry_195043, makeNimstrLit("serialize"), new_prim_func_191037(HEX3Aanonymous_195800));
		make_word_192991(spry_195043, makeNimstrLit("parse"), new_prim_func_191037(HEX3Aanonymous_195817));
		make_word_192991(spry_195043, makeNimstrLit("size"), new_prim_meth_191069(HEX3Aanonymous_195834));
		make_word_192991(spry_195043, makeNimstrLit("at:"), new_prim_meth_191069(HEX3Aanonymous_196013));
		make_word_192991(spry_195043, makeNimstrLit("at:put:"), new_prim_meth_191069(HEX3Aanonymous_196053));
		make_word_192991(spry_195043, makeNimstrLit("get:"), new_prim_meth_191069(HEX3Aanonymous_196089));
		make_word_192991(spry_195043, makeNimstrLit("set:to:"), new_prim_meth_191069(HEX3Aanonymous_196114));
		make_word_192991(spry_195043, makeNimstrLit("contains:"), new_prim_meth_191069(HEX3Aanonymous_196134));
		make_word_192991(spry_195043, makeNimstrLit("add:"), new_prim_meth_191069(HEX3Aanonymous_196169));
		make_word_192991(spry_195043, makeNimstrLit("removeLast"), new_prim_meth_191069(HEX3Aanonymous_196187));
		make_word_192991(spry_195043, makeNimstrLit("copyFrom:to:"), new_prim_meth_191069(HEX3Aanonymous_196205));
		make_word_192991(spry_195043, makeNimstrLit("do:"), new_prim_meth_191069(HEX3Aanonymous_196723));
		make_word_192991(spry_195043, makeNimstrLit("quit"), new_prim_func_191037(HEX3Aanonymous_196753));
		make_word_192991(spry_195043, makeNimstrLit("func"), new_prim_func_191037(HEX3Aanonymous_196770));
		make_word_192991(spry_195043, makeNimstrLit("method"), new_prim_func_191037(HEX3Aanonymous_196787));
		make_word_192991(spry_195043, makeNimstrLit("do"), new_prim_func_191037(HEX3Aanonymous_196804));
		make_word_192991(spry_195043, makeNimstrLit("$"), new_prim_func_191037(HEX3Aanonymous_196821));
		make_word_192991(spry_195043, makeNimstrLit("eva"), new_prim_func_191037(HEX3Aanonymous_196838));
		make_word_192991(spry_195043, makeNimstrLit("eval"), new_prim_func_191037(HEX3Aanonymous_196855));
		make_word_192991(spry_195043, makeNimstrLit("reify"), new_prim_func_191037(HEX3Aanonymous_196872));
		make_word_192991(spry_195043, makeNimstrLit("litify"), new_prim_func_191037(HEX3Aanonymous_196889));
		make_word_192991(spry_195043, makeNimstrLit("quote"), new_prim_func_191037(HEX3Aanonymous_196906));
		make_word_192991(spry_195043, makeNimstrLit("litword"), new_prim_func_191037(HEX3Aanonymous_196923));
		make_word_192991(spry_195043, makeNimstrLit("word"), new_prim_func_191037(HEX3Aanonymous_196940));
		make_word_192991(spry_195043, makeNimstrLit("clone"), new_prim_meth_191069(HEX3Aanonymous_196957));
		make_word_192991(spry_195043, makeNimstrLit("^"), new_prim_func_191037(HEX3Aanonymous_196974));
		make_word_192991(spry_195043, makeNimstrLit("then:"), new_prim_meth_191069(HEX3Aanonymous_196991));
		make_word_192991(spry_195043, makeNimstrLit("else:"), new_prim_meth_191069(HEX3Aanonymous_197008));
		make_word_192991(spry_195043, makeNimstrLit("then:else:"), new_prim_meth_191069(HEX3Aanonymous_197025));
		make_word_192991(spry_195043, makeNimstrLit("else:then:"), new_prim_meth_191069(HEX3Aanonymous_197043));
		make_word_192991(spry_195043, makeNimstrLit("repeat:"), new_prim_meth_191069(HEX3Aanonymous_197061));
		make_word_192991(spry_195043, makeNimstrLit("to:do:"), new_prim_meth_191069(HEX3Aanonymous_197089));
		make_word_192991(spry_195043, makeNimstrLit("whileTrue:"), new_prim_meth_191069(HEX3Aanonymous_197120));
		make_word_192991(spry_195043, makeNimstrLit("whileFalse:"), new_prim_meth_191069(HEX3Aanonymous_197139));

	
}

function eval_reduce_198608(self_198610, spry_198611) {
			var Tmp1;

	var result_198612 = null;

	BeforeRet: do {
		var collect_198629 = new_seq_186216(0);
		var current_198630 = new_activation_191231(self_198610);
		current_198630.parent = spry_198611.currentActivation;
			if (!(current_198630.self == null)) Tmp1 = false; else {				Tmp1 = !((current_198630.parent == null));			}		if (Tmp1) {
		current_198630.self = current_198630.parent.self;
		}
		
		spry_198611.currentActivation = current_198630;
		L2: do {
				L3: while (true) {
				if (!!(at_end_192314(current_198630))) break L3;
					var next_198642 = next_192331(current_198630);
					if (can_eval_193205(next_198642, spry_198611)) {
					current_198630.last = eval_190559(next_198642, spry_198611);
					if (current_198630.returned) {
					do_return_192411(spry_198611.currentActivation, spry_198611);
					result_198612 = current_198630.last;
					break BeforeRet;
					}
					
					if (collect_198629 != null) { collect_198629.push(current_198630.last); } else { collect_198629 = [current_198630.last]; };
					}
					else {
						current_198630.last = next_198642;
					}
					
				}
		} while(false);
		spry_198611.lastSelf = spry_198611.currentActivation.self;
		spry_198611.currentActivation = spry_198611.currentActivation.parent;
		result_198612 = new_blok_186293(collect_198629);
		break BeforeRet;
	} while (false);

	return result_198612;

}

function prim_reduce_198663(spry_198665) {
	var result_198666 = null;

		result_198666 = eval_reduce_198608(eval_arg_192974(spry_198665), spry_198665);

	return result_198666;

}

function add_extend_198680(spry_198682) {
		make_word_192991(spry_198682, makeNimstrLit("reduce"), new_prim_func_191037(prim_reduce_198663));

	
}

function binom_58014(n_58016, k_58017) {
	var result_58018 = 0;
	...
	BeforeRet: do {
		...
		if ((n_58016 < mulInt(2, k_58017))) {
		result_58018 = binom_58014(n_58016, subInt(n_58016, k_58017));
		break BeforeRet;
		}
		
		result_58018 = n_58016;
		L1: do {
			var i_58221 = 0;
			var res_226351 = 2;
			L2: do {
					L3: while (true) {
					if (!(res_226351 <= k_58017)) break L3;
						i_58221 = res_226351;
						result_58018 = divInt(mulInt(result_58018, subInt(addInt(n_58016, 1), i_58221)), i_58221);
						res_226351 = addInt(res_226351, 1);
					}
			} while(false);
		} while(false);
	} while (false);
...
function fac_58250(n_58252) {
	var result_58253 = 0;

		if (!((0 <= n_58252))) {
		failed_assert_impl_15051((makeNimstrLit("math.nim(92, 9) `n >= 0` ") || []).concat(cstrToNimstr((n_58252)+"") || [],makeNimstrLit(" must not be negative.") || []));
		}
		
		if (!((n_58252 < 13))) {
		failed_assert_impl_15051((makeNimstrLit("math.nim(93, 9) `n < factTable.len` ") || []).concat(cstrToNimstr((n_58252)+"") || [],makeNimstrLit(" is too large to look up in the table") || []));
		}
		
		result_58253 = fact_table_58450[chckIndx(n_58252, 0, fact_table_58450.length+0-1)-0];

	return result_58253;

}

function next_power_of_two_59081(x_59083) {
	var result_59084 = 0;

		result_59084 = (x_59083 - 1);
		result_59084 = (result_59084 | (result_59084 >> 16));
		result_59084 = (result_59084 | (result_59084 >> 8));
		result_59084 = (result_59084 | (result_59084 >> 4));
		result_59084 = (result_59084 | (result_59084 >> 2));
		result_59084 = (result_59084 | (result_59084 >> 1));
		result_59084 += (1 + ((x_59083 <= 0) ? 1:0));

	return result_59084;

}

function rotl_200630(x_200632, k_200633) {
	var result_200634 = 0;

		result_200634 = ((x_200632 << k_200633) | ((x_200632 >>> 0) >>> ((64 - k_200633) >>> 0)));

	return result_200634;

}

function next_200670(r_200673) {
	var result_200674 = 0;

		var s0_200675 = r_200673.a0;
		var s1_200676 = r_200673.a1;
		result_200674 = ((s0_200675 + s1_200676) >>> 0);
		s1_200676 = (s1_200676 ^ s0_200675);
		r_200673.a0 = ((rotl_200630(s0_200675, 55) ^ s1_200676) ^ (s1_200676 << 14));
		r_200673.a1 = rotl_200630(s1_200676, 36);

	return result_200674;

}

function random_200909(max_200911) {
	var result_200912 = 0.0;

		var x_200914 = next_200670(state_200405[0]);
		result_200912 = ((x_200914 / 4294967295) * max_200911);

	return result_200912;

}

function random_200870(max_200872) {
	var result_200873 = 0;
	...
	BeforeRet: do {
		L1: do {
				L2: while (true) {
				if (!true) break L2;
					var x_200875 = next_200670(state_200405[0]);
					if ((x_200875 < ((4294967295 - (4294967295 % chckRange(max_200872, 0, 4294967295))) >>> 0))) {
					result_200873 = (((x_200875 % max_200872))|0);
					break BeforeRet;
					}
	...
	return result_200873;

}

function add_math_218014(spry_218016) {

		function HEX3Aanonymous_218017(spry_218019) {
			var result_218020 = null;

			BeforeRet: do {
				var v_218021 = eval_arg_infix_192913(spry_218019);
				if (isObj(v_218021.m_type, NTI170191)) {
				result_218020 = new_value_186520(-(v_218021.value));
				break BeforeRet;
				}
				else {
					result_218020 = new_value_186488(negInt(v_218021.value));
					break BeforeRet;
				}
				
			} while (false);

			return result_218020;

		}

		function HEX3Aanonymous_218043(spry_218045) {
			var result_218046 = null;

				result_218046 = new_value_186488(binom_58014(eval_arg_infix_192913(spry_218045).value, eval_arg_192974(spry_218045).value));

			return result_218046;

		}

		function HEX3Aanonymous_218060(spry_218062) {
			var result_218063 = null;

				result_218063 = new_value_186488(fac_58250(eval_arg_infix_192913(spry_218062).value));

			return result_218063;

		}

		function HEX3Aanonymous_218077(spry_218079) {
			var result_218080 = null;

				result_218080 = new_value_186616(is_power_of_two_59062(eval_arg_infix_192913(spry_218079).value));

			return result_218080;

		}

		function HEX3Aanonymous_218094(spry_218096) {
			var result_218097 = null;

				result_218097 = new_value_186488(next_power_of_two_59081(eval_arg_infix_192913(spry_218096).value));

			return result_218097;

		}

		function HEX3Aanonymous_218111(spry_218113) {
			var result_218114 = null;

			BeforeRet: do {
				var max_218115 = eval_arg_infix_192913(spry_218113);
				if (isObj(max_218115.m_type, NTI170191)) {
				result_218114 = new_value_186520(random_200909(max_218115.value));
				break BeforeRet;
				}
				else {
					result_218114 = new_value_186488(random_200870(max_218115.value));
					break BeforeRet;
				}
				
			} while (false);

			return result_218114;

		}

		function HEX3Aanonymous_218137(spry_218139) {
			var result_218140 = null;

			BeforeRet: do {
				var self_218141 = eval_arg_infix_192913(spry_218139);
				if (isObj(self_218141.m_type, NTI170191)) {
				result_218140 = new_value_186520(Math.sqrt(self_218141.value));
				break BeforeRet;
				}
				else {
					result_218140 = new_value_186520(Math.sqrt(self_218141.value));
			...
			return result_218140;

		}

		function HEX3Aanonymous_218163(spry_218165) {
			var result_218166 = null;

				result_218166 = new_value_186520(Math.sin(eval_arg_infix_192913(spry_218165).value));

			return result_218166;

		}

		function HEX3Aanonymous_218184(spry_218186) {
			var result_218187 = null;

				result_218187 = new_value_186520(Math.cos(eval_arg_infix_192913(spry_218186).value));

			return result_218187;

		}

		make_word_192991(spry_218016, makeNimstrLit("negated"), new_prim_meth_191069(HEX3Aanonymous_218017));
		make_word_192991(spry_218016, makeNimstrLit("binom"), new_prim_meth_191069(HEX3Aanonymous_218043));
		make_word_192991(spry_218016, makeNimstrLit("fac"), new_prim_meth_191069(HEX3Aanonymous_218060));
		make_word_192991(spry_218016, makeNimstrLit("powerOfTwo?"), new_prim_meth_191069(HEX3Aanonymous_218077));
		make_word_192991(spry_218016, makeNimstrLit("nextPowerOfTwo"), new_prim_meth_191069(HEX3Aanonymous_218094));
		make_word_192991(spry_218016, makeNimstrLit("random"), new_prim_meth_191069(HEX3Aanonymous_218111));
		make_word_192991(spry_218016, makeNimstrLit("sqrt"), new_prim_meth_191069(HEX3Aanonymous_218137));
		make_word_192991(spry_218016, makeNimstrLit("sin"), new_prim_meth_191069(HEX3Aanonymous_218163));
		make_word_192991(spry_218016, makeNimstrLit("cos"), new_prim_meth_191069(HEX3Aanonymous_218184));

	
}

function new_poly_meth_219021(methods_219023, parent_219024) {
	var result_219025 = null;

		result_219025 = {nodes: nimCopy(null, methods_219023.nodes, NTI170213), parent: parent_219024, m_type: NTI219017, source: null, pos: 0, tags: null};

	return result_219025;

}

function polymeth_219039(methods_219041, spry_219042) {
	var result_219043 = null;

		result_219043 = new_poly_meth_219021(methods_219041, spry_219042.currentActivation);

	return result_219043;

}

function add_oo_219133(spry_219135) {

		function HEX3Aanonymous_219136(spry_219138) {
			var result_219139 = null;

				result_219139 = polymeth_219039(eval_arg_192974(spry_219138), spry_219138);

			return result_219139;

		}

		function HEX3Aanonymous_219153(spry_219155) {
			var result_219156 = null;

				var tags_219157 = eval_arg_infix_192913(spry_219155);
				result_219156 = meth_190547(spry_219155, eval_arg_192974(spry_219155));
				result_219156.tags = tags_219157;

			return result_219156;

		}

		make_word_192991(spry_219135, makeNimstrLit("polymethod"), new_prim_func_191037(HEX3Aanonymous_219136));
		make_word_192991(spry_219135, makeNimstrLit("->"), new_prim_meth_191069(HEX3Aanonymous_219153));

	
}

function dump_220347(spry_220349) {
		rawEcho(makeNimstrLit("STACK:"));
		L1: do {
			var a_220353 = null;
			var activation_226368 = spry_220349.currentActivation;
			L2: do {
					L3: while (true) {
					if (!!((activation_226368 == null))) break L3;
						a_220353 = activation_226368;
						dump_220239(a_220353);
						rawEcho(makeNimstrLit("-----------------------------"));
						activation_226368 = activation_226368.parent;
					}
			} while(false);
		} while(false);
		rawEcho(makeNimstrLit("========================================"));
...
function add_debug_220373(spry_220375) {

		function HEX3Aanonymous_220376(spry_220378) {
			var result_220379 = null;

				dump_220347(spry_220378);

			return result_220379;

		}

		make_word_192991(spry_220375, makeNimstrLit("dump"), new_prim_func_191037(HEX3Aanonymous_220376));

	
}

function substr_29653(s_29655, first_29656) {
	var result_29658 = null;

		result_29658 = nimCopy(null, substr_29622(s_29655, first_29656, (s_29655 != null ? (s_29655.length-1) : -1)), NTI138);

	return result_29658;

}

function nsuReplaceStr(s_155718, sub_155719, by_155720) {
	var result_155721 = null;

		result_155721 = nimCopy(null, [], NTI138);
		var sub_len_155722 = (sub_155719 != null ? sub_155719.length : 0);
		if ((sub_len_155722 == 0)) {
		result_155721 = nimCopy(null, s_155718, NTI138);
		}
		else {
		if ((sub_len_155722 == 1)) {
		var c_155723 = sub_155719[chckIndx(0, 0, sub_155719.length+0-1)-0];
		var last_155725 = (s_155718 != null ? (s_155718.length-1) : -1);
		var i_155727 = 0;
		L1: do {
				L2: while (true) {
				if (!true) break L2;
					var j_155728 = nsuFindChar(s_155718, c_155723, chckRange(i_155727, 0, 2147483647), last_155725);
					if ((j_155728 < 0)) {
					break L1;
					}
					
					if (result_155721 != null) { result_155721 = (result_155721).concat(substr_29622(s_155718, i_155727, subInt(j_155728, 1))); } else { result_155721 = substr_29622(s_155718, i_155727, subInt(j_155728, 1)).slice(); };
					if (result_155721 != null) { result_155721 = (result_155721).concat(by_155720); } else { result_155721 = by_155720.slice(); };
					i_155727 = addInt(j_155728, sub_len_155722);
				}
		} while(false);
		if (result_155721 != null) { result_155721 = (result_155721).concat(substr_29653(s_155718, i_155727)); } else { result_155721 = substr_29653(s_155718, i_155727).slice(); };
		}
		else {
			var a_155729 = [new Int32Array(256)];
			nsuInitSkipTable(a_155729[0], sub_155719);
			var last_155732 = (s_155718 != null ? (s_155718.length-1) : -1);
			var i_155734 = 0;
			L3: do {
					L4: while (true) {
					if (!true) break L4;
						var j_155735 = nsuFindStrA(a_155729[0], s_155718, sub_155719, chckRange(i_155734, 0, 2147483647), last_155732);
						if ((j_155735 < 0)) {
						break L3;
						}
						
						if (result_155721 != null) { result_155721 = (result_155721).concat(substr_29622(s_155718, i_155734, subInt(j_155735, 1))); } else { result_155721 = substr_29622(s_155718, i_155734, subInt(j_155735, 1)).slice(); };
						if (result_155721 != null) { result_155721 = (result_155721).concat(by_155720); } else { result_155721 = by_155720.slice(); };
						i_155734 = addInt(j_155735, sub_len_155722);
					}
			} while(false);
			if (result_155721 != null) { result_155721 = (result_155721).concat(substr_29653(s_155718, i_155734)); } else { result_155721 = substr_29653(s_155718, i_155734).slice(); };
		}
		}

	return result_155721;

}

function eval_root_do_193943(self_193945, spry_193946) {
			var Tmp1;

	var result_193947 = null;

		spry_193946.lastSelf = spry_193946.currentActivation.self;
		spry_193946.currentActivation = spry_193946.currentActivation.parent;
		spry_193946.rootActivation.body = self_193945;
		spry_193946.rootActivation.pos = 0;
		result_193947 = eval_193668(spry_193946.rootActivation, spry_193946);
		spry_193946.rootActivation.parent = spry_193946.currentActivation;
			if (!(spry_193946.rootActivation.self == null)) Tmp1 = false; else {				Tmp1 = !((spry_193946.rootActivation.parent == null));			}		if (Tmp1) {
		spry_193946.rootActivation.self = spry_193946.rootActivation.parent.self;
		}
		
		spry_193946.currentActivation = spry_193946.rootActivation;

	return result_193947;

}

function eval_root_190551(spry_190553, code_190554) {
	var result_193976 = null;

		result_193976 = eval_root_do_193943(parse_190275(spry_190553.parser, code_190554), spry_190553);

	return result_193976;

}

function add_string_221028(spry_221030) {

		function HEX3Aanonymous_221031(spry_221033) {
			var result_221034 = null;

			BeforeRet: do {
				var s_221035 = nimCopy(null, eval_arg_infix_192913(spry_221033).value, NTI138);
				var sep_221036 = nimCopy(null, eval_arg_192974(spry_221033).value, NTI138);
				var blk_221037 = new_blok_186326();
				L1: do {
					var token_221038 = null;
					var last_226371 = 0;
					var splits_226372 = -1;
					L2: do {
							L3: while (true) {
							if (!(last_226371 <= (s_221035 != null ? s_221035.length : 0))) break L3;
								var first_226374 = last_226371;
								L4: do {
										L5: while (true) {
										if (!((last_226371 < (s_221035 != null ? s_221035.length : 0)) && !(substr_eq_149102(s_221035, last_226371, sep_221036)))) break L5;
											last_226371 = addInt(last_226371, 1);
										}
								} while(false);
								if ((splits_226372 == 0)) {
								last_226371 = (s_221035 != null ? s_221035.length : 0);
								}
								
								token_221038 = substr_29622(s_221035, first_226374, subInt(last_226371, 1));
								add_186711(blk_221037, new_value_186552(token_221038));
								if ((splits_226372 == 0)) {
								break L2;
								}
								
								splits_226372 = subInt(splits_226372, 1);
								last_226371 = addInt(last_226371, (sep_221036 != null ? sep_221036.length : 0));
							}
					} while(false);
				} while(false);
				result_221034 = blk_221037;
				break BeforeRet;
			} while (false);

			return result_221034;

		}

		function HEX3Aanonymous_221052(spry_221054) {
			var result_221055 = null;

			BeforeRet: do {
				var self_221056 = eval_arg_infix_192913(spry_221054);
				var sub_221057 = nimCopy(null, eval_arg_192974(spry_221054).value, NTI138);
				var by_221058 = nimCopy(null, eval_arg_192974(spry_221054).value, NTI138);
				self_221056.value = nimCopy(null, nsuReplaceStr(self_221056.value, sub_221057, by_221058), NTI138);
				result_221055 = self_221056;
				break BeforeRet;
			} while (false);

			return result_221055;

		}

		function HEX3Aanonymous_221072(spry_221074) {
			var result_221075 = null;

				var self_221076 = nimCopy(null, eval_arg_infix_192913(spry_221074).value, NTI138);
				var sub_221077 = nimCopy(null, eval_arg_192974(spry_221074).value, NTI138);
				var start_221078 = eval_arg_192974(spry_221074).value;
				result_221075 = new_value_186488(nsuFindStr(self_221076, sub_221077, chckRange(start_221078, 0, 2147483647), 0));

			return result_221075;

		}

		make_word_192991(spry_221030, makeNimstrLit("split:"), new_prim_meth_191069(HEX3Aanonymous_221031));
		make_word_192991(spry_221030, makeNimstrLit("replace:with:"), new_prim_meth_191069(HEX3Aanonymous_221052));
		make_word_192991(spry_221030, makeNimstrLit("findString:startingAt:"), new_prim_meth_191069(HEX3Aanonymous_221072));
		eval_root_190551(spry_221030, makeNimstrLit("[\x0A    findString: = method [self findString: :s startingAt: 0]\x0A  ]"));

	
}

function add_modules_222015(spry_222017) {
		eval_root_190551(spry_222017, makeNimstrLit("[\x0A    # Load a Module from a string\x0A    loadString: = func [:code\x0A      map = eval parse code\x0A      loadMap: map as: ((map at: \'_meta) at: \'name)\x0A    ]\x0A\x0A    loadString:as: = func [:code :name\x0A      loadMap: (eval parse code) as: name\x0A    ]\x0A\x0A    loadFile: = func [\x0A      loadString: readFile :fileName]\x0A\x0A    loadFile:as: = func [\x0A      loadString: (readFile :fileName) as: :name]\x0A\x0A    loadMap:as: = func [:map :name\x0A      root at: name put: map\x0A      true\x0A    ]\x0A\x0A    existsFile \"spry.sy\" then: [\x0A      #echo \"Loading spry.sy ...\"\x0A      loadFile: \"spry.sy\"\x0A    ]\x0A  ]"));

	
}

function add_reflect_223426(spry_223428) {

		function HEX3Aanonymous_223429(spry_223431) {
			var result_223432 = null;

				result_223432 = new_or_get_lit_word_182107(spry_223431.parser, type_name_223032(eval_arg_infix_192913(spry_223431)));

			return result_223432;

		}

		function HEX3Aanonymous_223446(spry_223448) {
			var result_223449 = null;

			BeforeRet: do {
				var node_223450 = eval_arg_infix_192913(spry_223448);
				result_223449 = node_223450.source;
				if ((result_223449 == null)) {
				result_223449 = spry_223448.nilVal;
				break BeforeRet;
				}
				
			} while (false);

			return result_223449;

		}

		function HEX3Aanonymous_223469(spry_223471) {
			var result_223472 = null;

			BeforeRet: do {
				var node_223473 = eval_arg_infix_192913(spry_223471);
				node_223473.source = eval_arg_192974(spry_223471);
				result_223472 = node_223473;
				break BeforeRet;
			} while (false);

			return result_223472;

		}

		make_word_192991(spry_223428, makeNimstrLit("type"), new_prim_meth_191069(HEX3Aanonymous_223429));
		make_word_192991(spry_223428, makeNimstrLit("source"), new_prim_meth_191069(HEX3Aanonymous_223446));
		make_word_192991(spry_223428, makeNimstrLit("source:"), new_prim_meth_191069(HEX3Aanonymous_223469));

	
}

function HEX5BHEX5D_190907(self_190909, key_190910) {
	var result_190911 = null;

		result_190911 = self_190909.nodes[chckIndx(key_190910, 0, self_190909.nodes.length+0-1)-0];

	return result_190911;

}

function HEX5BHEX5DHEX3D_190979(self_190981, key_190982, val_190983) {
		self_190981.nodes[chckIndx(key_190982, 0, self_190981.nodes.length+0-1)-0] = val_190983;

	
}

function new_blok_224028(size_224030) {
	var result_224031 = null;

		result_224031 = {nodes: new_seq_186216(chckRange(size_224030, 0, 2147483647)), m_type: NTI170220, pos: 0, tags: null};

	return result_224031;

}

function fill_224364(a_224369, value_224370) {
		var x_224377 = 0;
		L1: do {
				L2: while (true) {
				if (!(x_224377 <= (a_224369 != null ? (a_224369.length-1) : -1))) break L2;
					a_224369[chckIndx(x_224377, 0, a_224369.length+0-1)-0] = value_224370;
					x_224377 = addInt(x_224377, 1);
				}
		} while(false);
...
function reverse_224462(a_224467, first_224468, last_224469) {
		var x_224470 = first_224468;
		var y_224471 = last_224469;
		L1: do {
				L2: while (true) {
				if (!(x_224470 < y_224471)) break L2;
					var Tmp3 = a_224467[chckIndx(x_224470, 0, a_224467.length+0-1)-0]; a_224467[chckIndx(x_224470, 0, a_224467.length+0-1)-0] = a_224467[chckIndx(y_224471, 0, a_224467.length+0-1)-0]; a_224467[chckIndx(y_224471, 0, a_224467.length+0-1)-0] = Tmp3;					y_224471 = subInt(y_224471, 1);
					x_224470 = addInt(x_224470, 1);
				}
		} while(false);
...
function reverse_224450(a_224455) {
		reverse_224462(a_224455, 0, chckRange(nimMax(0, (a_224455 != null ? (a_224455.length-1) : -1)), 0, 2147483647));

	
}

function add_block_224061(spry_224063) {

		function HEX3Aanonymous_224064(spry_224066) {
			var result_224067 = null;

				result_224067 = HEX5BHEX5D_190907(eval_arg_infix_192913(spry_224066), 0);

			return result_224067;

		}

		function HEX3Aanonymous_224081(spry_224083) {
			var result_224084 = null;

				result_224084 = HEX5BHEX5D_190907(eval_arg_infix_192913(spry_224083), 1);

			return result_224084;

		}

		function HEX3Aanonymous_224098(spry_224100) {
			var result_224101 = null;

				result_224101 = HEX5BHEX5D_190907(eval_arg_infix_192913(spry_224100), 2);

			return result_224101;

		}

		function HEX3Aanonymous_224115(spry_224117) {
			var result_224118 = null;

				result_224118 = HEX5BHEX5D_190907(eval_arg_infix_192913(spry_224117), 3);

			return result_224118;

		}

		function HEX3Aanonymous_224132(spry_224134) {
			var result_224135 = null;

				result_224135 = HEX5BHEX5D_190907(eval_arg_infix_192913(spry_224134), 4);

			return result_224135;

		}

		function HEX3Aanonymous_224149(spry_224151) {
			var result_224152 = null;

				var nodes_224153 = nimCopy(null, eval_arg_infix_192913(spry_224151).nodes, NTI170213);
				result_224152 = nodes_224153[chckIndx((nodes_224153 != null ? (nodes_224153.length-1) : -1), 0, nodes_224153.length+0-1)-0];

			return result_224152;

		}

		function HEX3Aanonymous_224173(spry_224175) {
			var result_224176 = null;

				eval_arg_infix_192913(spry_224175).pos = 0;

			return result_224176;

		}

		function HEX3Aanonymous_224190(spry_224192) {
			var result_224193 = null;

				result_224193 = new_value_186488(eval_arg_infix_192913(spry_224192).pos);

			return result_224193;

		}

		function HEX3Aanonymous_224207(spry_224209) {
			var result_224210 = null;

				result_224210 = eval_arg_infix_192913(spry_224209);
				var comp_224211 = result_224210;
				comp_224211.pos = eval_arg_192974(spry_224209).value;

			return result_224210;

		}

		function HEX3Aanonymous_224225(spry_224227) {
			var result_224228 = null;

				var comp_224229 = eval_arg_infix_192913(spry_224227);
				result_224228 = HEX5BHEX5D_190907(comp_224229, comp_224229.pos);

			return result_224228;

		}

		function HEX3Aanonymous_224243(spry_224245) {
			var result_224246 = null;

				result_224246 = eval_arg_infix_192913(spry_224245);
				var comp_224247 = result_224246;
				HEX5BHEX5DHEX3D_190979(comp_224247, comp_224247.pos, eval_arg_192974(spry_224245));

			return result_224246;

		}

		function HEX3Aanonymous_224261(spry_224263) {
			var result_224264 = null;

			BeforeRet: do {
				var comp_224265 = eval_arg_infix_192913(spry_224263);
				if ((comp_224265.pos == (comp_224265.nodes != null ? comp_224265.nodes.length : 0))) {
				result_224264 = spry_224263.undefVal;
				break BeforeRet;
				}
				
				result_224264 = HEX5BHEX5D_190907(comp_224265, comp_224265.pos);
				comp_224265.pos = addInt(comp_224265.pos, 1);
			} while (false);

			return result_224264;

		}

		function HEX3Aanonymous_224290(spry_224292) {
			var result_224293 = null;

			BeforeRet: do {
				var comp_224294 = eval_arg_infix_192913(spry_224292);
				if ((comp_224294.pos == 0)) {
				result_224293 = spry_224292.undefVal;
				break BeforeRet;
				}
				
				comp_224294.pos = subInt(comp_224294.pos, 1);
				result_224293 = HEX5BHEX5D_190907(comp_224294, comp_224294.pos);
			} while (false);

			return result_224293;

		}

		function HEX3Aanonymous_224314(spry_224316) {
			var result_224317 = null;

				var comp_224318 = eval_arg_infix_192913(spry_224316);
				result_224317 = new_value_186616((comp_224318.pos == (comp_224318.nodes != null ? comp_224318.nodes.length : 0)));

			return result_224317;

		}

		function HEX3Aanonymous_224337(spry_224339) {
			var result_224340 = null;

			BeforeRet: do {
				result_224340 = new_blok_186326();
				break BeforeRet;
			} while (false);
		...
		function HEX3Aanonymous_224354(spry_224356) {
			var result_224357 = null;

			BeforeRet: do {
				var size_224358 = eval_arg_192974(spry_224356);
				var blok_224359 = new_blok_224028(size_224358.value);
				fill_224364(blok_224359.nodes, spry_224356.nilVal);
				result_224357 = blok_224359;
				break BeforeRet;
			} while (false);

			return result_224357;

		}

		function HEX3Aanonymous_224411(spry_224413) {
			var result_224414 = null;

			BeforeRet: do {
				var self_224415 = eval_arg_infix_192913(spry_224413);
				var filler_224416 = eval_arg_192974(spry_224413);
				fill_224364(self_224415.nodes, filler_224416);
				result_224414 = self_224415;
				break BeforeRet;
			} while (false);

			return result_224414;

		}

		function HEX3Aanonymous_224441(spry_224443) {
			var result_224444 = null;

			BeforeRet: do {
				var self_224445 = eval_arg_infix_192913(spry_224443);
				reverse_224450(self_224445.nodes);
				result_224444 = self_224445;
				break BeforeRet;
			} while (false);

			return result_224444;

		}

		function HEX3Aanonymous_224530(spry_224532) {
			var result_224533 = null;

			BeforeRet: do {
				var self_224534 = eval_arg_infix_192913(spry_224532);
				var blk_224535 = eval_arg_192974(spry_224532);
				var return_blok_224536 = new_blok_186326();
				var current_224537 = spry_224532.currentActivation;
				var orig_224538 = current_224537.body.nodes[chckIndx(0, 0, current_224537.body.nodes.length+0-1)-0];
				var oldpos_224539 = current_224537.pos;
				current_224537.pos = 0;
				var activation_224540 = new_activation_191231(blk_224535);
				L1: do {
					var each_224547 = null;
					var colontmp__226382 = null;
					colontmp__226382 = self_224534.nodes;
					var i_226383 = 0;
					var l_226384 = (colontmp__226382 != null ? colontmp__226382.length : 0);
					L2: do {
							L3: while (true) {
							if (!(i_226383 < l_226384)) break L3;
								each_224547 = colontmp__226382[chckIndx(i_226383, 0, colontmp__226382.length+0-1)-0];
								current_224537.body.nodes[chckIndx(0, 0, current_224537.body.nodes.length+0-1)-0] = each_224547;
								result_224533 = eval_193668(activation_224540, spry_224532);
								reset_191355(activation_224540);
								if (current_224537.returned) {
								current_224537.body.nodes[chckIndx(0, 0, current_224537.body.nodes.length+0-1)-0] = orig_224538;
								current_224537.pos = oldpos_224539;
								break BeforeRet;
								}
								
								add_186711(return_blok_224536, result_224533);
								current_224537.pos = 0;
								i_226383 = addInt(i_226383, 1);
								if (!(((colontmp__226382 != null ? colontmp__226382.length : 0) == l_226384))) {
								failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
								}
				...
				current_224537.body.nodes[chckIndx(0, 0, current_224537.body.nodes.length+0-1)-0] = orig_224538;
				current_224537.pos = oldpos_224539;
				result_224533 = return_blok_224536;
				break BeforeRet;
			} while (false);

			return result_224533;

		}

		function HEX3Aanonymous_224561(spry_224563) {
			var result_224564 = null;

			BeforeRet: do {
				var self_224565 = eval_arg_infix_192913(spry_224563);
				var blk_224566 = eval_arg_192974(spry_224563);
				var return_blok_224567 = new_blok_186326();
				var current_224568 = spry_224563.currentActivation;
				var orig_224569 = current_224568.body.nodes[chckIndx(0, 0, current_224568.body.nodes.length+0-1)-0];
				var oldpos_224570 = current_224568.pos;
				current_224568.pos = 0;
				var activation_224571 = new_activation_191231(blk_224566);
				L1: do {
					var each_224578 = null;
					var colontmp__226387 = null;
					colontmp__226387 = self_224565.nodes;
					var i_226388 = 0;
					var l_226389 = (colontmp__226387 != null ? colontmp__226387.length : 0);
					L2: do {
							L3: while (true) {
							if (!(i_226388 < l_226389)) break L3;
								each_224578 = colontmp__226387[chckIndx(i_226388, 0, colontmp__226387.length+0-1)-0];
								current_224568.body.nodes[chckIndx(0, 0, current_224568.body.nodes.length+0-1)-0] = each_224578;
								result_224564 = eval_193668(activation_224571, spry_224563);
								reset_191355(activation_224571);
								if (current_224568.returned) {
								current_224568.body.nodes[chckIndx(0, 0, current_224568.body.nodes.length+0-1)-0] = orig_224569;
								current_224568.pos = oldpos_224570;
								break BeforeRet;
								}
								
								if (value_172612(result_224564)) {
								add_186711(return_blok_224567, each_224578);
								}
								
								current_224568.pos = 0;
								i_226388 = addInt(i_226388, 1);
								if (!(((colontmp__226387 != null ? colontmp__226387.length : 0) == l_226389))) {
								failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
								}
				...
				current_224568.body.nodes[chckIndx(0, 0, current_224568.body.nodes.length+0-1)-0] = orig_224569;
				current_224568.pos = oldpos_224570;
				result_224564 = return_blok_224567;
				break BeforeRet;
			} while (false);

			return result_224564;

		}

		function HEX3Aanonymous_224592(spry_224594) {
			var result_224595 = null;

			BeforeRet: do {
				var blk_224596 = eval_arg_infix_192913(spry_224594);
				var sum_224597 = 0;
				var sum2_224598 = 0.0;
				var found_float_224599 = false;
				L1: do {
					var each_224606 = null;
					var colontmp__226394 = null;
					colontmp__226394 = blk_224596.nodes;
					var i_226395 = 0;
					var l_226396 = (colontmp__226394 != null ? colontmp__226394.length : 0);
					L2: do {
							L3: while (true) {
							if (!(i_226395 < l_226396)) break L3;
								each_224606 = colontmp__226394[chckIndx(i_226395, 0, colontmp__226394.length+0-1)-0];
								if (isObj(each_224606.m_type, NTI170188)) {
								sum_224597 = addInt(sum_224597, each_224606.value);
								}
								else {
								if (isObj(each_224606.m_type, NTI170191)) {
								found_float_224599 = true;
								sum2_224598 = (sum2_224598 + each_224606.value);
								}
								else {
								raise_runtime_exception_170382(makeNimstrLit("Block contained something other than an int or float, can not sum."));
								}
								}
								i_226395 = addInt(i_226395, 1);
								if (!(((colontmp__226394 != null ? colontmp__226394.length : 0) == l_226396))) {
								failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
								}
				...
				if (found_float_224599) {
				result_224595 = new_value_186520((sum2_224598 + sum_224597));
				break BeforeRet;
				}
				else {
					result_224595 = new_value_186488(sum_224597);
					break BeforeRet;
				}
				
			} while (false);

			return result_224595;

		}

		function HEX3Aanonymous_224636(spry_224638) {
			var result_224639 = null;

			BeforeRet: do {
				var self_224640 = eval_arg_infix_192913(spry_224638);
				var return_blok_224641 = new_blok_186326();
				L1: do {
					var each_224648 = null;
					var colontmp__226400 = null;
					colontmp__226400 = self_224640.nodes;
					var i_226401 = 0;
					var l_226402 = (colontmp__226400 != null ? colontmp__226400.length : 0);
					L2: do {
							L3: while (true) {
							if (!(i_226401 < l_226402)) break L3;
								each_224648 = colontmp__226400[chckIndx(i_226401, 0, colontmp__226400.length+0-1)-0];
								if ((8 < each_224648.value)) {
								add_186711(return_blok_224641, each_224648);
								}
								
								i_226401 = addInt(i_226401, 1);
								if (!(((colontmp__226400 != null ? colontmp__226400.length : 0) == l_226402))) {
								failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
								}
				...
				result_224639 = return_blok_224641;
				break BeforeRet;
			} while (false);

			return result_224639;

		}

		make_word_192991(spry_224063, makeNimstrLit("first"), new_prim_meth_191069(HEX3Aanonymous_224064));
		make_word_192991(spry_224063, makeNimstrLit("second"), new_prim_meth_191069(HEX3Aanonymous_224081));
		make_word_192991(spry_224063, makeNimstrLit("third"), new_prim_meth_191069(HEX3Aanonymous_224098));
		make_word_192991(spry_224063, makeNimstrLit("fourth"), new_prim_meth_191069(HEX3Aanonymous_224115));
		make_word_192991(spry_224063, makeNimstrLit("fifth"), new_prim_meth_191069(HEX3Aanonymous_224132));
		make_word_192991(spry_224063, makeNimstrLit("last"), new_prim_meth_191069(HEX3Aanonymous_224149));
		make_word_192991(spry_224063, makeNimstrLit("reset"), new_prim_meth_191069(HEX3Aanonymous_224173));
		make_word_192991(spry_224063, makeNimstrLit("pos"), new_prim_meth_191069(HEX3Aanonymous_224190));
		make_word_192991(spry_224063, makeNimstrLit("pos:"), new_prim_meth_191069(HEX3Aanonymous_224207));
		make_word_192991(spry_224063, makeNimstrLit("read"), new_prim_meth_191069(HEX3Aanonymous_224225));
		make_word_192991(spry_224063, makeNimstrLit("write:"), new_prim_meth_191069(HEX3Aanonymous_224243));
		make_word_192991(spry_224063, makeNimstrLit("next"), new_prim_meth_191069(HEX3Aanonymous_224261));
		make_word_192991(spry_224063, makeNimstrLit("prev"), new_prim_meth_191069(HEX3Aanonymous_224290));
		make_word_192991(spry_224063, makeNimstrLit("end?"), new_prim_meth_191069(HEX3Aanonymous_224314));
		make_word_192991(spry_224063, makeNimstrLit("newBlock"), new_prim_func_191037(HEX3Aanonymous_224337));
		make_word_192991(spry_224063, makeNimstrLit("newBlock:"), new_prim_func_191037(HEX3Aanonymous_224354));
		make_word_192991(spry_224063, makeNimstrLit("fill:"), new_prim_meth_191069(HEX3Aanonymous_224411));
		make_word_192991(spry_224063, makeNimstrLit("reverse"), new_prim_meth_191069(HEX3Aanonymous_224441));
		make_word_192991(spry_224063, makeNimstrLit("map:"), new_prim_meth_191069(HEX3Aanonymous_224530));
		make_word_192991(spry_224063, makeNimstrLit("select:"), new_prim_meth_191069(HEX3Aanonymous_224561));
		make_word_192991(spry_224063, makeNimstrLit("sum"), new_prim_meth_191069(HEX3Aanonymous_224592));
		make_word_192991(spry_224063, makeNimstrLit("selectLarger8"), new_prim_meth_191069(HEX3Aanonymous_224636));
		eval_root_190551(spry_224063, makeNimstrLit("[\x0A    # Collections\x0A    sprydo: = method [:fun\x0A      self reset\x0A      [self end?] whileFalse: [do fun (self next)]\x0A    ]\x0A\x0A    detect: = method [:pred\x0A      self reset\x0A      [self end?] whileFalse: [\x0A        n = (self next)\x0A        do pred n then: [^n]]\x0A      ^nil\x0A    ]\x0A\x0A    spryselect: = method [:pred\x0A      result = ([] clone)\x0A      self reset\x0A      [self end?] whileFalse: [\x0A        n = (self next)\x0A        do pred n then: [result add: n]]\x0A      ^result]\x0A\x0A    spryselectdo: = method [:pred\x0A      result = ([] clone)\x0A      self do: [\x0A        do pred :n then: [result add: n]]\x0A      ^result]\x0A]"));

	
}

function add_browser_225018(spry_225020) {

		function HEX3Aanonymous_225021(spry_225023) {
			var result_225024 = null;

				result_225024 = spry_225023.nilVal;
				echoSpry(toJSStr(print_174068(eval_arg_192974(spry_225023))));

			return result_225024;

		}

		function HEX3Aanonymous_225038(spry_225040) {
			var result_225041 = null;

				result_225041 = eval_arg_192974(spry_225040);
				echoSpry(toJSStr(HEX24_170617(result_225041)));

			return result_225041;

		}

		make_word_192991(spry_225020, makeNimstrLit("echo"), new_prim_func_191037(HEX3Aanonymous_225021));
		make_word_192991(spry_225020, makeNimstrLit("probe"), new_prim_func_191037(HEX3Aanonymous_225038));

	
}
var spry_226014 = [new_interpreter_194012()];
add_core_195041(spry_226014[0]);
add_extend_198680(spry_226014[0]);
add_math_218014(spry_226014[0]);
add_oo_219133(spry_226014[0]);
add_debug_220373(spry_226014[0]);
add_string_221028(spry_226014[0]);
add_modules_222015(spry_226014[0]);
add_reflect_223426(spry_226014[0]);
add_block_224061(spry_226014[0]);
add_browser_225018(spry_226014[0]);

function spryEval(code_226406) {
	var result_226407 = null;

		result_226407 = toJSStr(HEX24_170617(eval_root_190551(spry_226014[0], (makeNimstrLit("[") || []).concat(cstrToNimstr(code_226406) || [],makeNimstrLit("]") || []))));

	return result_226407;
...
function map_171910(s_171915, op_171918) {
	var result_171920 = null;
		...
		result_171920 = new Array(chckRange((s_171915 != null ? s_171915.length : 0), 0, 2147483647)); for (var i=0;i<chckRange((s_171915 != null ? s_171915.length : 0), 0, 2147483647);++i) {result_171920[i]=null;}		L1: do {
			var i_171943 = 0;
			var colontmp__226629 = 0;
			colontmp__226629 = (s_171915 != null ? s_171915.length : 0);
			var i_226630 = 0;
			L2: do {
					L3: while (true) {
					if (!(i_226630 < colontmp__226629)) break L3;
						i_171943 = i_226630;
...
function HEX24_172264(self_172266) {
	var result_172267 = null;
		...
		L1: do {
			var i_172281 = 0;
			var colontmp__226634 = 0;
			colontmp__226634 = subInt((self_172266.keys != null ? self_172266.keys.length : 0), 1);
			var res_226635 = 0;
			L2: do {
					L3: while (true) {
					if (!(res_226635 <= colontmp__226634)) break L3;
						i_172281 = res_226635;
						...
						res_226635 = addInt(res_226635, 1);
					}
			} while(false);
		} while(false);
...
function HEX24_219057(self_219059) {
	var result_219060 = null;

	BeforeRet: do {
		result_219060 = nimCopy(null, (makeNimstrLit("polymethod [") || []).concat(HEX24_171885(self_219059.nodes) || [],makeNimstrLit("]") || []), NTI138);
		break BeforeRet;
	} while (false);

	return result_219060;
...
function HEX24_170647(self_170649) {
	...
	BeforeRet: do {
		...
		L1: do {
			var k_171614 = null;
			var v_171615 = null;
			var colontmp__226641 = {data: null, counter: 0};
			nimCopy(colontmp__226641, self_170649.bindings, NTI170233);
			var l_226649 = len_170785(colontmp__226641);
			L2: do {
				var h_226651 = 0;
				var colontmp__226652 = 0;
				colontmp__226652 = (colontmp__226641.data != null ? (colontmp__226641.data.length-1) : -1);
				var res_226653 = 0;
				L3: do {
						L4: while (true) {
						if (!(res_226653 <= colontmp__226652)) break L4;
							h_226651 = res_226653;
							if (is_filled_166418(colontmp__226641.data[chckIndx(h_226651, 0, colontmp__226641.data.length+0-1)-0].Field0)) {
							k_171614 = colontmp__226641.data[chckIndx(h_226651, 0, colontmp__226641.data.length+0-1)-0].Field1;
							v_171615 = colontmp__226641.data[chckIndx(h_226651, 0, colontmp__226641.data.length+0-1)-0].Field2;
							if (first_170651) {
...
function nsuToHex(x_150450, len_150451) {
	var result_150452 = null;
		...
		L1: do {
			var j_150461 = 0;
			var colontmp__226662 = 0;
			colontmp__226662 = subInt(len_150451, 1);
			var res_226663 = colontmp__226662;
			L2: do {
					L3: while (true) {
					if (!(0 <= res_226663)) break L3;
						j_150461 = res_226663;
						...
						res_226663 = subInt(res_226663, 1);
					}
			} while(false);
		} while(false);
...
function nsuEscape(s_156000, prefix_156001, suffix_156002) {
	var result_156003 = null;
		...
		L1: do {
			var c_156012 = 0;
			var i_226658 = 0;
			var l_226659 = (s_156000 != null ? s_156000.length : 0);
			L2: do {
					L3: while (true) {
					if (!(i_226658 < l_226659)) break L3;
						c_156012 = s_156000[chckIndx(i_226658, 0, s_156000.length+0-1)-0];
						switch (c_156012) {
						case 0:
						case 1:
						case 2:
						...
						i_226658 = addInt(i_226658, 1);
						if (!(((s_156000 != null ? s_156000.length : 0) == l_226659))) {
...
function HEX24_170617(self_170560) {
	...
	BeforeRet: do {
		...
		if (isObj(self_170560.m_type, NTI219017)) {
		result_170619 = HEX24_219057(self_170560);
		break BeforeRet;
		}
		else {
...
function hash_172798(x_172802) {
	var result_172803 = 0;
		...
		L1: do {
			var i_173006 = 0;
			var colontmp__226670 = 0;
			colontmp__226670 = (x_172802 != null ? (x_172802.length-1) : -1);
			var res_226671 = 0;
			L2: do {
					L3: while (true) {
					if (!(res_226671 <= colontmp__226670)) break L3;
						i_173006 = res_226671;
						result_172803 = HEX21HEX26_162059(result_172803, hash_172312(x_172802[chckIndx(i_173006, 0, x_172802.length+0-1)-0]));
						res_226671 = addInt(res_226671, 1);
					}
			} while(false);
		} while(false);
...
function HEX3DHEX3D_173056(x_173060, y_173062) {
	...
	BeforeRet: do {
		...
		L1: do {
			var i_174024 = 0;
			var colontmp__226685 = 0;
			colontmp__226685 = subInt((x_173060 != null ? x_173060.length : 0), 1);
			var res_226686 = 0;
			L2: do {
					L3: while (true) {
					if (!(res_226686 <= colontmp__226685)) break L3;
						i_174024 = res_226686;
						...
						res_226686 = addInt(res_226686, 1);
					}
			} while(false);
		} while(false);
		result_173063 = true;
...
function concat_187105(seqs_187110) {
	var result_187112 = null;
		...
		L1: do {
			...
			L2: do {
					L3: while (true) {
					if (!(i_226693 < (seqs_187110 != null ? seqs_187110.length : 0))) break L3;
						seqitm_187145 = seqs_187110[chckIndx(i_226693, 0, seqs_187110.length+0-1)-0];
						l_187114 = addInt(l_187114, (seqitm_187145 != null ? seqitm_187145.length : 0));
						i_226693 = addInt(i_226693, 1);
					}
			} while(false);
		} while(false);
		...
		L4: do {
			...
			L5: do {
					L6: while (true) {
					if (!(i_226700 < (seqs_187110 != null ? seqs_187110.length : 0))) break L6;
						s_187171 = seqs_187110[chckIndx(i_226700, 0, seqs_187110.length+0-1)-0];
						L7: do {
							var itm_187414 = null;
							var i_226697 = 0;
							var l_226698 = (s_187171 != null ? s_187171.length : 0);
							L8: do {
									L9: while (true) {
									if (!(i_226697 < l_226698)) break L9;
										itm_187414 = s_187171[chckIndx(i_226697, 0, s_187171.length+0-1)-0];
										result_187112[chckIndx(i_187165, 0, result_187112.length+0-1)-0] = itm_187414;
										i_187165 = addInt(i_187165, 1);
										i_226697 = addInt(i_226697, 1);
										if (!(((s_187171 != null ? s_187171.length : 0) == l_226698))) {
										failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
										}
...
function new_map_182042(bindings_182051) {
	var result_182052 = null;
		...
		L1: do {
			...
			var l_226703 = len_170785(bindings_182051);
			L2: do {
				var h_226705 = 0;
				var colontmp__226706 = 0;
				colontmp__226706 = (bindings_182051.data != null ? (bindings_182051.data.length-1) : -1);
				var res_226707 = 0;
				L3: do {
						L4: while (true) {
						if (!(res_226707 <= colontmp__226706)) break L4;
							h_226705 = res_226707;
							if (is_filled_166418(bindings_182051.data[chckIndx(h_226705, 0, bindings_182051.data.length+0-1)-0].Field0)) {
							key_182060 = bindings_182051.data[chckIndx(h_226705, 0, bindings_182051.data.length+0-1)-0].Field1;
							binding_182061 = bindings_182051.data[chckIndx(h_226705, 0, bindings_182051.data.length+0-1)-0].Field2;
							make_binding_177643(result_182052, key_182060, binding_182061.val);
							if (!((len_170785(bindings_182051) == l_226703))) {
							failed_assert_impl_15051(makeNimstrLit("tables.nim(669, 13) `len(t) == L` the length of the table changed while iterating over it"));
							}
							
							}
							
							res_226707 = addInt(res_226707, 1);
						}
				} while(false);
			} while(false);
		} while(false);
...
function HEX5BHEX5D_198143(s_198147, x_198149) {
	var result_198150 = null;

		var a_198201 = subInt((s_198147 != null ? s_198147.length : 0), x_198149.a);
		var l_198401 = addInt(subInt(subInt((s_198147 != null ? s_198147.length : 0), x_198149.b), a_198201), 1);
		result_198150 = nimCopy(null, mnewString(chckRange(l_198401, 0, 2147483647)), NTI138);
		L1: do {
			var i_198409 = 0;
			var i_226742 = 0;
			L2: do {
					L3: while (true) {
					if (!(i_226742 < l_198401)) break L3;
						i_198409 = i_226742;
						result_198150[chckIndx(i_198409, 0, result_198150.length+0-1)-0] = s_198147[chckIndx(addInt(i_198409, a_198201), 0, s_198147.length+0-1)-0];
						i_226742 = addInt(i_226742, 1);
					}
			} while(false);
		} while(false);

	return result_198150;

}

function HEX2EHEX2E_198078(a_198082, b_198083) {
	var result_198089 = {a: 0, b: 0};

		nimCopy(result_198089, {a: a_198082, b: b_198083}, NTI198086);

	return result_198089;

}

function parse_value_198034(self_198036, s_198037) {
			var Tmp1;

	var result_198038 = null;

		if ((5 < (s_198037 != null ? s_198037.length : 0))) {
			if (!eqStrings(HEX5BHEX5D_74681(s_198037, HEX2EHEX2E_74620(0, 2)), makeNimstrLit("\'\'\'"))) Tmp1 = false; else {				Tmp1 = eqStrings(HEX5BHEX5D_198143(s_198037, HEX2EHEX2E_198078(3, 1)), makeNimstrLit("\'\'\'"));			}		if (Tmp1) {
		result_198038 = new_value_186552(HEX5BHEX5D_101704(s_198037, HEX2EHEX2E_101639(3, 4)));
		}
		
		}
		

	return result_198038;
...
function parse_value_188168(self_188152, s_188153) {
	...
	BeforeRet: do {
		...
		if (isObj(self_188152.m_type, NTI198017)) {
		result_188170 = parse_value_198034(self_188152, s_188153);
		break BeforeRet;
		}
		else {
...
function token_ready_198516(self_198518, token_198519, c_198520) {
			var Tmp1;
			var Tmp2;

	var result_198521 = null;

	BeforeRet: do {
			if (!(c_198520 == 39)) Tmp2 = false; else {				Tmp2 = (4 < (token_198519 != null ? token_198519.length : 0));			}			if (!Tmp2) Tmp1 = false; else {				Tmp1 = eqStrings(HEX5BHEX5D_198143(token_198519, HEX2EHEX2E_198078(2, 1)), makeNimstrLit("\'\'"));			}		if (Tmp1) {
		result_198521 = nimCopy(null, (token_198519 || []).concat([c_198520]), NTI138);
		break BeforeRet;
		}
		else {
			result_198521 = nimCopy(null, null, NTI138);
			break BeforeRet;
		}
		
	} while (false);

	return result_198521;
...
function token_ready_188274(self_188257, token_188258, ch_188259) {
	...
	BeforeRet: do {
		...
		if (isObj(self_188257.m_type, NTI198017)) {
		result_188276 = token_ready_198516(self_188257, token_188258, ch_188259);
		break BeforeRet;
		}
		else {
...
function token_start_198495(self_198497, s_198498, c_198499) {
	var result_198500 = false;

		result_198500 = (eqStrings(s_198498, makeNimstrLit("\'\'")) && (c_198499 == 39));

	return result_198500;
...
function token_start_188296(self_188279, token_188280, ch_188281) {
	...
	BeforeRet: do {
		...
		result_188298 = token_start_198495(self_188279, token_188280, ch_188281);
		break BeforeRet;
		}
		else {
		if (isObj(self_188279.m_type, NTI170133)) {
...
function make_local_binding_192841(spry_192843, key_192844, val_192845) {
	...
	BeforeRet: do {
		L1: do {
			...
			var colontmp__226751 = null;
			colontmp__226751 = spry_192843.currentActivation;
			var activation_226752 = colontmp__226751;
			L2: do {
					L3: while (true) {
					if (!!((activation_226752 == null))) break L3;
						L4: do {
								L5: while (true) {
								if (!!(!(isObj(activation_226752.m_type, NTI190489)))) break L5;
									if (isObj(activation_226752.m_type, NTI190487)) {
									Tmp6 = activation_226752.body.parent;
									}
									else {
									Tmp6 = activation_226752.parent;
									}
									
									activation_226752 = Tmp6;
								}
						} while(false);
						activation_192847 = activation_226752;
						result_192846 = make_binding_192695(activation_192847, key_192844, val_192845);
						break BeforeRet;
						if (isObj(activation_226752.m_type, NTI190487)) {
						Tmp7 = activation_226752.body.parent;
						}
						else {
						Tmp7 = activation_226752.parent;
						}
						
						activation_226752 = Tmp7;
					}
			} while(false);
		} while(false);
	} while (false);
...
function eval_219075(self_219077, spry_219078) {
	var result_219079 = null;

	BeforeRet: do {
		var receiver_219080 = eval_arg_infix_192913(spry_219078);
		if ((receiver_219080 == null)) {
		result_219079 = spry_219078.nilVal;
		break BeforeRet;
		}
		
		var tags_219086 = receiver_219080.tags;
		if ((tags_219086 == null)) {
		result_219079 = spry_219078.nilVal;
		break BeforeRet;
		}
		
		var node_tags_219092 = nimCopy(null, tags_219086.nodes, NTI170213);
		if ((node_tags_219092 == null)) {
		result_219079 = spry_219078.nilVal;
		break BeforeRet;
		}
		...
		L1: do {
			var n_219104 = null;
			var colontmp__226765 = null;
			colontmp__226765 = self_219077.nodes;
			var i_226766 = 0;
			var l_226767 = (colontmp__226765 != null ? colontmp__226765.length : 0);
			L2: do {
					L3: while (true) {
					if (!(i_226766 < l_226767)) break L3;
						n_219104 = colontmp__226765[chckIndx(i_226766, 0, colontmp__226765.length+0-1)-0];
						var fun_tags_219105 = nimCopy(null, n_219104.tags.nodes, NTI170213);
						L4: do {
							var nt_219112 = null;
							var i_226762 = 0;
							var l_226763 = (node_tags_219092 != null ? node_tags_219092.length : 0);
							L5: do {
									L6: while (true) {
									if (!(i_226762 < l_226763)) break L6;
										nt_219112 = node_tags_219092[chckIndx(i_226762, 0, node_tags_219092.length+0-1)-0];
										if (contains_186812(fun_tags_219105, nt_219112)) {
										result_219079 = eval_190559(n_219104, spry_219078);
										break BeforeRet;
										}
										
										i_226762 = addInt(i_226762, 1);
										if (!(((node_tags_219092 != null ? node_tags_219092.length : 0) == l_226763))) {
										failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
										}
						...
						i_226766 = addInt(i_226766, 1);
						if (!(((colontmp__226765 != null ? colontmp__226765.length : 0) == l_226767))) {
						failed_assert_impl_15051(makeNimstrLit("iterators.nim(190, 11) `len(a) == L` the length of the seq changed while iterating over it"));
						}
...
function lookup_parent_192649(spry_192651, key_192652) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			var colontmp__226771 = null;
			colontmp__226771 = spry_192651.currentActivation;
			var activation_226772 = colontmp__226771;
			L2: do {
					L3: while (true) {
					if (!!((activation_226772 == null))) break L3;
						L4: do {
								L5: while (true) {
								if (!!(!(isObj(activation_226772.m_type, NTI190489)))) break L5;
									if (isObj(activation_226772.m_type, NTI190487)) {
									Tmp6 = activation_226772.body.parent;
									}
									else {
									Tmp6 = activation_226772.parent;
									}
									
									activation_226772 = Tmp6;
								}
						} while(false);
						activation_192655 = activation_226772;
						if (in_parent_192654) {
						...
						if (isObj(activation_226772.m_type, NTI190487)) {
						Tmp7 = activation_226772.body.parent;
						}
						else {
						Tmp7 = activation_226772.parent;
						}
						
						activation_226772 = Tmp7;
					}
			} while(false);
		} while(false);
	} while (false);
...
function eval_190559(self_190557, spry_190558) {
	...
	BeforeRet: do {
		...
		if (isObj(self_190557.m_type, NTI219017)) {
		result_193362 = eval_219075(self_190557, spry_190558);
		break BeforeRet;
		}
		else {
...
function make_binding_in_map_192783(spry_192785, key_192786, val_192787) {
	...
	BeforeRet: do {
		L1: do {
			...
			var colontmp__226796 = null;
			colontmp__226796 = spry_192785.currentActivation;
			var activation_226797 = colontmp__226796;
			L2: do {
					L3: while (true) {
					if (!!((activation_226797 == null))) break L3;
						L4: do {
								L5: while (true) {
								if (!!(!(isObj(activation_226797.m_type, NTI190489)))) break L5;
									if (isObj(activation_226797.m_type, NTI190487)) {
									Tmp6 = activation_226797.body.parent;
									}
									else {
									Tmp6 = activation_226797.parent;
									}
									
									activation_226797 = Tmp6;
								}
						} while(false);
						activation_192789 = activation_226797;
						...
						break BeforeRet;
						if (isObj(activation_226797.m_type, NTI190487)) {
						Tmp7 = activation_226797.body.parent;
						}
						else {
						Tmp7 = activation_226797.parent;
						}
						
						activation_226797 = Tmp7;
					}
			} while(false);
		} while(false);
	} while (false);
...
function make_binding_in_map_192750(spry_192752, key_192753, val_192754) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			var colontmp__226804 = null;
			colontmp__226804 = spry_192752.currentActivation;
			var activation_226805 = colontmp__226804;
			L2: do {
					L3: while (true) {
					if (!!((activation_226805 == null))) break L3;
						L4: do {
								L5: while (true) {
								if (!!(!(isObj(activation_226805.m_type, NTI190489)))) break L5;
									if (isObj(activation_226805.m_type, NTI190487)) {
									Tmp6 = activation_226805.body.parent;
									}
									else {
									Tmp6 = activation_226805.parent;
									}
									
									activation_226805 = Tmp6;
								}
						} while(false);
						activation_192758 = activation_226805;
						if (in_parent_192756) {
						...
						if (isObj(activation_226805.m_type, NTI190487)) {
						Tmp7 = activation_226805.body.parent;
						}
						else {
						Tmp7 = activation_226805.parent;
						}
						
						activation_226805 = Tmp7;
					}
			} while(false);
		} while(false);
...
function make_binding_in_map_192722(spry_192724, key_192725, val_192726) {
	...
	BeforeRet: do {
		L1: do {
			...
			var colontmp__226812 = null;
			colontmp__226812 = spry_192724.currentActivation;
			var activation_226813 = colontmp__226812;
			L2: do {
					L3: while (true) {
					if (!!((activation_226813 == null))) break L3;
						L4: do {
								L5: while (true) {
								if (!!(!(isObj(activation_226813.m_type, NTI190489)))) break L5;
									if (isObj(activation_226813.m_type, NTI190487)) {
									Tmp6 = activation_226813.body.parent;
									}
									else {
									Tmp6 = activation_226813.parent;
									}
									
									activation_226813 = Tmp6;
								}
						} while(false);
						activation_192728 = activation_226813;
						...
						break BeforeRet;
						if (isObj(activation_226813.m_type, NTI190487)) {
						Tmp7 = activation_226813.body.parent;
						}
						else {
						Tmp7 = activation_226813.parent;
						}
						
						activation_226813 = Tmp7;
					}
			} while(false);
		} while(false);
	} while (false);
...
function dump_220291(self_220293) {
		rawEcho(makeNimstrLit("FUNKACTIVATION"));
		rawEcho(HEX24_170617(self_220293.body));
		if ((self_220293.pos < len_191015(self_220293))) {
		rawEcho((makeNimstrLit("POS(") || []).concat(cstrToNimstr((self_220293.pos)+"") || [],makeNimstrLit("): ") || [],HEX24_170617(HEX5BHEX5D_190907(self_220293.body, self_220293.pos)) || []));
		}
		
		rawEcho(HEX24_170617(self_220293.locals));

	
}

function dump_220266(self_220268) {
		rawEcho(makeNimstrLit("CURLYACTIVATION"));
		rawEcho(HEX24_170617(self_220268.body));
		if ((self_220268.pos < len_191015(self_220268))) {
		rawEcho((makeNimstrLit("POS(") || []).concat(cstrToNimstr((self_220268.pos)+"") || [],makeNimstrLit("): ") || [],HEX24_170617(HEX5BHEX5D_190907(self_220268.body, self_220268.pos)) || []));
		}
...
function dump_220241(self_220243) {
		rawEcho(makeNimstrLit("PARENACTIVATION"));
		rawEcho(HEX24_170617(self_220243.body));
		if ((self_220243.pos < len_191015(self_220243))) {
		rawEcho((makeNimstrLit("POS(") || []).concat(cstrToNimstr((self_220243.pos)+"") || [],makeNimstrLit("): ") || [],HEX24_170617(HEX5BHEX5D_190907(self_220243.body, self_220243.pos)) || []));
		}
...
function dump_220319(self_220321) {
		rawEcho(makeNimstrLit("BLOKACTIVATION"));
		rawEcho(HEX24_170617(self_220321.body));
		if ((self_220321.pos < len_191015(self_220321))) {
		rawEcho((makeNimstrLit("POS(") || []).concat(cstrToNimstr((self_220321.pos)+"") || [],makeNimstrLit("): ") || [],HEX24_170617(HEX5BHEX5D_190907(self_220321.body, self_220321.pos)) || []));
		}
		
		rawEcho(HEX24_170617(self_220321.locals));

	
}

function dump_220214(self_220216) {
		rawEcho(makeNimstrLit("ACTIVATION"));
		rawEcho(HEX24_170617(self_220216.body));
		if ((self_220216.pos < len_191015(self_220216))) {
		rawEcho((makeNimstrLit("POS(") || []).concat(cstrToNimstr((self_220216.pos)+"") || [],makeNimstrLit("): ") || [],HEX24_170617(HEX5BHEX5D_190907(self_220216.body, self_220216.pos)) || []));
		}
...
function dump_220239(self_220216) {
		chckNilDisp(self_220216);
		if (isObj(self_220216.m_type, NTI190487)) {
		dump_220291(self_220216);
		}
		else {
		if (isObj(self_220216.m_type, NTI190491)) {
		dump_220266(self_220216);
		}
		else {
		if (isObj(self_220216.m_type, NTI190489)) {
		dump_220241(self_220216);
		}
		else {
		if (isObj(self_220216.m_type, NTI190484)) {
		dump_220319(self_220216);
		}
		else {
		if (isObj(self_220216.m_type, NTI190476)) {
		dump_220214(self_220216);
		}
		}}}}
...
function type_name_223290(self_223292) {
	var result_223293 = null;

		result_223293 = nimCopy(null, makeNimstrLit("litword"), NTI138);

	return result_223293;

}

function type_name_223273(self_223275) {
	var result_223276 = null;

		result_223276 = nimCopy(null, makeNimstrLit("getouterword"), NTI138);

	return result_223276;

}

function type_name_223358(self_223360) {
	var result_223361 = null;

		result_223361 = nimCopy(null, makeNimstrLit("paren"), NTI138);

	return result_223361;

}

function type_name_223341(self_223343) {
	var result_223344 = null;

		result_223344 = nimCopy(null, makeNimstrLit("block"), NTI138);

	return result_223344;

}

function type_name_223256(self_223258) {
	var result_223259 = null;

		result_223259 = nimCopy(null, makeNimstrLit("getselfword"), NTI138);

	return result_223259;

}

function type_name_223239(self_223241) {
	var result_223242 = null;

		result_223242 = nimCopy(null, makeNimstrLit("getmoduleword"), NTI138);

	return result_223242;

}

function type_name_223222(self_223224) {
	var result_223225 = null;

		result_223225 = nimCopy(null, makeNimstrLit("getword"), NTI138);

	return result_223225;

}

function type_name_223205(self_223207) {
	var result_223208 = null;

		result_223208 = nimCopy(null, makeNimstrLit("evalouterword"), NTI138);

	return result_223208;

}

function type_name_223409(self_223411) {
	var result_223412 = null;

		result_223412 = nimCopy(null, makeNimstrLit("binding"), NTI138);

	return result_223412;

}

function type_name_223324(self_223326) {
	var result_223327 = null;

		result_223327 = nimCopy(null, makeNimstrLit("getargword"), NTI138);

	return result_223327;

}

function type_name_223307(self_223309) {
	var result_223310 = null;

		result_223310 = nimCopy(null, makeNimstrLit("evalargword"), NTI138);

	return result_223310;

}

function type_name_223052(self_223054) {
	var result_223055 = null;

		result_223055 = nimCopy(null, makeNimstrLit("float"), NTI138);

	return result_223055;

}

function type_name_223035(self_223037) {
	var result_223038 = null;

		result_223038 = nimCopy(null, makeNimstrLit("int"), NTI138);

	return result_223038;

}

function type_name_223392(self_223394) {
	var result_223395 = null;

		result_223395 = nimCopy(null, makeNimstrLit("map"), NTI138);

	return result_223395;

}

function type_name_223375(self_223377) {
	var result_223378 = null;

		result_223378 = nimCopy(null, makeNimstrLit("curly"), NTI138);

	return result_223378;

}

function type_name_223120(self_223122) {
	var result_223123 = null;

		result_223123 = nimCopy(null, makeNimstrLit("novalue"), NTI138);

	return result_223123;

}

function type_name_223103(self_223105) {
	var result_223106 = null;

		result_223106 = nimCopy(null, makeNimstrLit("boolean"), NTI138);

	return result_223106;

}

function type_name_223086(self_223088) {
	var result_223089 = null;

		result_223089 = nimCopy(null, makeNimstrLit("boolean"), NTI138);

	return result_223089;

}

function type_name_223069(self_223071) {
	var result_223072 = null;

		result_223072 = nimCopy(null, makeNimstrLit("string"), NTI138);

	return result_223072;

}

function type_name_223188(self_223190) {
	var result_223191 = null;

		result_223191 = nimCopy(null, makeNimstrLit("evalselfword"), NTI138);

	return result_223191;

}

function type_name_223171(self_223173) {
	var result_223174 = null;

		result_223174 = nimCopy(null, makeNimstrLit("evalmoduleword"), NTI138);

	return result_223174;

}

function type_name_223154(self_223156) {
	var result_223157 = null;

		result_223157 = nimCopy(null, makeNimstrLit("evalword"), NTI138);

	return result_223157;

}

function type_name_223137(self_223139) {
	var result_223140 = null;

		result_223140 = nimCopy(null, makeNimstrLit("undefined"), NTI138);

	return result_223140;

}

function type_name_223015(self_223017) {
	var result_223018 = null;

		raise_runtime_exception_170382(makeNimstrLit("Nodes need to implement typeName"));

	return result_223018;

}

function type_name_223032(self_223017) {
	var result_223034 = null;

	BeforeRet: do {
		chckNilDisp(self_223017);
		if (isObj(self_223017.m_type, NTI170152)) {
		result_223034 = type_name_223290(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170176)) {
		result_223034 = type_name_223273(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170216)) {
		result_223034 = type_name_223358(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170220)) {
		result_223034 = type_name_223341(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170172)) {
		result_223034 = type_name_223256(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170169)) {
		result_223034 = type_name_223239(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170167)) {
		result_223034 = type_name_223222(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170163)) {
		result_223034 = type_name_223205(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170248)) {
		result_223034 = type_name_223409(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170178)) {
		result_223034 = type_name_223324(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170165)) {
		result_223034 = type_name_223307(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170191)) {
		result_223034 = type_name_223052(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170188)) {
		result_223034 = type_name_223035(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170223)) {
		result_223034 = type_name_223392(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170218)) {
		result_223034 = type_name_223375(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170208)) {
		result_223034 = type_name_223120(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170204)) {
		result_223034 = type_name_223103(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170202)) {
		result_223034 = type_name_223086(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170194)) {
		result_223034 = type_name_223069(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170159)) {
		result_223034 = type_name_223188(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170156)) {
		result_223034 = type_name_223171(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170154)) {
		result_223034 = type_name_223154(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170206)) {
		result_223034 = type_name_223137(self_223017);
		break BeforeRet;
		}
		else {
		if (isObj(self_223017.m_type, NTI170142)) {
		result_223034 = type_name_223015(self_223017);
		break BeforeRet;
		}
		}}}}}}}}}}}}}}}}}}}}}}}
	} while (false);

	return result_223034;
